...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM773constructorimpl = Result.m773constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM773constructorimpl = Result.m773constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m779isFailureimpl(objM773constructorimpl) ? null : objM773constructorimpl);
    ...
    static final void installSignalHandler$lambda$1(Signal signal) {
