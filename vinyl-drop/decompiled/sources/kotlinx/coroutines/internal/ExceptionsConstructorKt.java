...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM773constructorimpl = Result.m773constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM773constructorimpl = Result.m773constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m779isFailureimpl(objM773constructorimpl)) {
                objM773constructorimpl = null;
            }
            return (E) objM773constructorimpl;
        }
    ...
    static final Throwable createConstructor$lambda$7$lambda$1(Constructor constructor, Throwable th) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    static final Throwable createConstructor$lambda$7$lambda$3(Constructor constructor, Throwable th) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    static final Throwable createConstructor$lambda$7$lambda$4(Constructor constructor, Throwable th) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        Object objNewInstance = constructor.newInstance(th);
        Intrinsics.checkNotNull(objNewInstance, "null cannot be cast to non-null type kotlin.Throwable");
        return (Throwable) objNewInstance;
    }

    static final Throwable createConstructor$lambda$7$lambda$6(Constructor constructor, Throwable th) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    static final Throwable safeCtor$lambda$9(Function1 function1, Throwable th) {
        ...
        try {
            ...
            objM773constructorimpl = Result.m773constructorimpl(th2);
        } catch (Throwable th3) {
            Result.Companion companion2 = Result.INSTANCE;
            objM773constructorimpl = Result.m773constructorimpl(ResultKt.createFailure(th3));
        }
        return (Throwable) (Result.m779isFailureimpl(objM773constructorimpl) ? null : objM773constructorimpl);
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM773constructorimpl = Result.m773constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM773constructorimpl = Result.m773constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m779isFailureimpl(objM773constructorimpl)) {
            objM773constructorimpl = numValueOf;
        }
        return ((Number) objM773constructorimpl).intValue();
    }
