...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2331scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2257delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2258toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2258toDelayMillisLRDsOJo(long j) {
        boolean zM2144isPositiveimpl = Duration.m2144isPositiveimpl(j);
        if (zM2144isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m2128getInWholeMillisecondsimpl(Duration.m2146plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM2144isPositiveimpl) {
