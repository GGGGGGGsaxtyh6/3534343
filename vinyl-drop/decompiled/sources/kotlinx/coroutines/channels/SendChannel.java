...
public interface SendChannel<E> {
    ...
    Object mo2268trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2292isSuccessimpl(objMo2268trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2286exceptionOrNullimpl = ChannelResult.m2286exceptionOrNullimpl(objMo2268trySendJP2dKIU);
