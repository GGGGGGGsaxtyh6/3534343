...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM2301trySendImplMj0NB7M = conflatedBufferedChannel.m2301trySendImplMj0NB7M(e, true);
        if (objM2301trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2286exceptionOrNullimpl(objM2301trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM2301trySendImplMj0NB7M = conflatedBufferedChannel.m2301trySendImplMj0NB7M(e, true);
        if (!(objM2301trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2268trySendJP2dKIU(E element) {
        return m2301trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2301trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2300trySendDropLatestMj0NB7M(element, isSendOp) : m2276trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2300trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo2268trySendJP2dKIU = super.mo2268trySendJP2dKIU(element);
        if (ChannelResult.m2292isSuccessimpl(objMo2268trySendJP2dKIU) || ChannelResult.m2290isClosedimpl(objMo2268trySendJP2dKIU)) {
            return objMo2268trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo2268trySendJP2dKIU = mo2268trySendJP2dKIU(element);
        if (!(objMo2268trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo2268trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2286exceptionOrNullimpl(objMo2268trySendJP2dKIU);
