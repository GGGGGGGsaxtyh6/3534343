        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m773constructorimpl(ResultKt.createFailure(cancellationExceptionRecoverFromStackFrame)));
                    ...
                    continuation.resumeWith(Result.m773constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(objTakeState$kotlinx_coroutines_core)));
                }
