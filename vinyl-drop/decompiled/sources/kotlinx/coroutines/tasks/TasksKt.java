            ...
            public final void onComplete(Task<T> task2) {
                ...
                if (exception2 == null) {
                    ...
                    if (zIsCanceled) {
                        ...
                        cancellableContinuation.resumeWith(Result.m773constructorimpl(task2.getResult()));
                        return;
                    }
                }
                Continuation continuation2 = cancellableContinuationImpl2;
                Result.Companion companion2 = Result.INSTANCE;
                continuation2.resumeWith(Result.m773constructorimpl(ResultKt.createFailure(exception2)));
            }
        });
        if (cancellationTokenSource != null) {
