...
class Compiler {
    ...
    static Prog compileRegexp(Regexp regexp) {
        ...
        compiler.prog.patch(fragCompile.out, compiler.newInst(6).i);
    ...
    /* JADX INFO: renamed from: com.google.re2j.Compiler$1, reason: invalid class name */
