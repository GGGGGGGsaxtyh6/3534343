...
public final class MinimalEncoder {
    ...
    private static final class Edge {
        ...
        private static final int[] allCodewordCapacities = {3, 5, 8, 10, 12, 16, 18, 22, 30, 32, 36, 44, 49, 62, 86, 114, 144, 174, MlKitException.CODE_SCANNER_TASK_IN_PROGRESS, 280, 368, 456, 576, 696, 816, ClientProto.OAUTH_SCOPES_FIELD_NUMBER, 1304, 1558};
        private static final int[] squareCodewordCapacities = {3, 5, 8, 12, 18, 22, 30, 36, 44, 62, 86, 114, 144, 174, MlKitException.CODE_SCANNER_TASK_IN_PROGRESS, 280, 368, 456, 576, 696, 816, ClientProto.OAUTH_SCOPES_FIELD_NUMBER, 1304, 1558};
        ...
        */
        byte[] getLatchBytes() {
            /*
                r12 = this;
                com.google.zxing.datamatrix.encoder.MinimalEncoder$Mode r0 = r12.getPreviousMode()
                int r0 = r0.ordinal()
                ...
                goto L6f
            L24:
                com.google.zxing.datamatrix.encoder.MinimalEncoder$Mode r0 = r12.mode
                com.google.zxing.datamatrix.encoder.MinimalEncoder$Mode r11 = r12.getPreviousMode()
                if (r0 == r11) goto L6f
                com.google.zxing.datamatrix.encoder.MinimalEncoder$Mode r0 = r12.mode
                int r0 = r0.ordinal()
                ...
                goto L6f
            L41:
                byte[] r0 = getBytes(r11, r1)
                return r0
            L46:
                byte[] r0 = getBytes(r11, r2)
                return r0
            L4b:
                byte[] r0 = getBytes(r11, r3)
                return r0
            L50:
                byte[] r0 = getBytes(r11, r4)
                return r0
            L55:
                byte[] r0 = getBytes(r11, r5)
                return r0
            L5a:
                byte[] r0 = getBytes(r11)
                return r0
            L5f:
                com.google.zxing.datamatrix.encoder.MinimalEncoder$Mode r0 = r12.mode
                int r0 = r0.ordinal()
            ...
            L87:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.datamatrix.encoder.MinimalEncoder.Edge.getLatchBytes():byte[]");
        }
