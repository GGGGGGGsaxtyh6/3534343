...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private void updateCollapsedBounds(boolean z) {
        ...
        int i2 = this.tmpRect.right - (z ? titleMarginStart : titleMarginEnd);
        int i3 = this.tmpRect.top + maxOffsetForPinChild + titleMarginTop;
        int i4 = (this.tmpRect.bottom + maxOffsetForPinChild) - titleMarginBottom;
        ...
        if (this.collapsedTitleGravityMode == 0) {
            ...
            int i5 = this.tmpRect.left + (z ? titleMarginEnd : titleMarginStart);
