    ...
    public static zzke zzc(zzqb zzqbVar, @Nullable zzch zzchVar) throws GeneralSecurityException {
        ...
        try {
            ...
            if (zzkbVarZza.zzd().equals(zzkb.zzc.zzd)) {
                return zzke.zza(zzkh.zza(zzkbVarZza, zzaaj.zza(zzvqVarZzd.zzf().zzd()), zzqbVar.zze()), zzaal.zza(zzvnVarZza.zze().zzd(), zzch.zza(zzchVar)));
            }
            return zzke.zza(zzkh.zza(zzkbVarZza, new ECPoint(zzne.zza(zzvqVarZzd.zzf().zzd()), zzne.zza(zzvqVarZzd.zzg().zzd())), zzqbVar.zze()), zzaam.zza(zzne.zza(zzvnVarZza.zze().zzd()), zzch.zza(zzchVar)));
