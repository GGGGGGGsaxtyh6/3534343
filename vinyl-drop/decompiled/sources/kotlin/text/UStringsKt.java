...
public final class UStringsKt {
    ...
    public static final String m2104toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2106toStringolVBNx4(short s, int i) {
    ...
    public static final String m2105toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m2103toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m873constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m785boximpl(UByte.m791constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m873constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m1053boximpl(UShort.m1059constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM873constructorimpl = UInt.m873constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM873constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM873constructorimpl2 = UInt.m873constructorimpl(i3 * iM873constructorimpl);
            int iM873constructorimpl3 = UInt.m873constructorimpl(UInt.m873constructorimpl(iDigitOf) + iM873constructorimpl2);
            if (Integer.compare(iM873constructorimpl3 ^ Integer.MIN_VALUE, iM873constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM873constructorimpl3;
        }
        return UInt.m867boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM952constructorimpl = ULong.m952constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM952constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM952constructorimpl2 = ULong.m952constructorimpl(j * jM952constructorimpl);
            long jM952constructorimpl3 = ULong.m952constructorimpl(ULong.m952constructorimpl(((long) UInt.m873constructorimpl(iDigitOf)) & 4294967295L) + jM952constructorimpl2);
            if (Long.compare(jM952constructorimpl3 ^ Long.MIN_VALUE, jM952constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM952constructorimpl3;
        }
        return ULong.m946boximpl(j);
    }
}
