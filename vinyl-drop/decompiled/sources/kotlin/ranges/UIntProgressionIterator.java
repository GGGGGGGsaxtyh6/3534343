...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m867boximpl(m2009nextpVg5ArA());
    }
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m873constructorimpl(i3);
    ...
    public int m2009nextpVg5ArA() {
        ...
        this.next = UInt.m873constructorimpl(this.step + i);
        return i;
    }
}
