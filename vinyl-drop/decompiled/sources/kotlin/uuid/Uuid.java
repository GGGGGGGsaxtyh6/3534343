...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m946boximpl(ULong.m952constructorimpl(getMostSignificantBits())), ULong.m946boximpl(ULong.m952constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m2253toUByteArrayTcUX1vc() {
        return UByteArray.m849constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        return j != other.mostSignificantBits ? Long.compare(ULong.m952constructorimpl(j) ^ Long.MIN_VALUE, ULong.m952constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m952constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m952constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m2255fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m2254fromUByteArrayGBYM_sE(byte[] ubyteArray) {
