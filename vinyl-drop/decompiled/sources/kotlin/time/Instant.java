...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public final Instant m2215minusLRDsOJo(long duration) {
        return m2217plusLRDsOJo(Duration.m2161unaryMinusUwyO8pc(duration));
    }

    /* JADX INFO: renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m2216minusUwyO8pc(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.INSTANCE;
        long duration = DurationKt.toDuration(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS);
        Duration.Companion companion2 = Duration.INSTANCE;
        return Duration.m2146plusLRDsOJo(duration, DurationKt.toDuration(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }
    ...
    public final Instant m2217plusLRDsOJo(long duration) {
        long jM2131getInWholeSecondsimpl = Duration.m2131getInWholeSecondsimpl(duration);
        int iM2133getNanosecondsComponentimpl = Duration.m2133getNanosecondsComponentimpl(duration);
        if (jM2131getInWholeSecondsimpl == 0 && iM2133getNanosecondsComponentimpl == 0) {
            return this;
        }
        long j = this.epochSeconds;
        long j2 = j + jM2131getInWholeSecondsimpl;
        if ((j ^ j2) >= 0 || (jM2131getInWholeSecondsimpl ^ j) < 0) {
            return INSTANCE.fromEpochSeconds(j2, this.nanosecondsOfSecond + iM2133getNanosecondsComponentimpl);
        }
        return Duration.m2144isPositiveimpl(duration) ? MAX : MIN;
    }
}
