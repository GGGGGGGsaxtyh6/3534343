...
public class Carousel extends MotionHelper {
    ...
    public void updateItems() {
        ...
        int i5 = this.mIndex;
        int i6 = this.mBackwardTransition;
        if (i5 == 0) {
            enableTransition(i6, false);
        } else {
            enableTransition(i6, true);
            this.mMotionLayout.setTransition(this.mBackwardTransition);
        }
        int i7 = this.mIndex;
        int i8 = iCount3 - 1;
        int i9 = this.mForwardTransition;
        if (i7 == i8) {
            enableTransition(i9, false);
        } else {
            enableTransition(i9, true);
