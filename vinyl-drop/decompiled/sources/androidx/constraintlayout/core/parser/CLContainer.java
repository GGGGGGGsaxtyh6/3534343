...
public class CLContainer extends CLElement {
    ...
    public CLContainer mo347clone() {
        CLContainer cLContainer = (CLContainer) super.mo347clone();
        ArrayList<CLElement> arrayList = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement cLElementMo347clone = it.next().mo347clone();
            cLElementMo347clone.setContainer(cLContainer);
            arrayList.add(cLElementMo347clone);
        }
