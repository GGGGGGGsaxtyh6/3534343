...
public class MotionLabel extends View implements FloatLayout {
        ...
        if (this.mAutoSize) {
            ...
            if (zIsNaN) {
                ...
                if (f5 > f7) {
                    ...
                    textPaint.setTextSize((this.mPaintTextSize * f3) / f6);
                }
            } else {
                float f8 = iWidth;
                float f9 = iHeight;
                f = f8 * f3 > f9 * f2 ? f2 / f8 : f3 / f9;
            }
        }
    ...
    public void layout(float f, float f2, float f3, float f4) {
        ...
        if (this.mAutoSize) {
            ...
            float f9 = fWidth * f8;
            float f10 = fHeight * f7;
            TextPaint textPaint = this.mPaint;
            if (f9 > f10) {
                textPaint.setTextSize((this.mPaintTextSize * f7) / fWidth);
            } else {
                textPaint.setTextSize((this.mPaintTextSize * f8) / fHeight);
            }
