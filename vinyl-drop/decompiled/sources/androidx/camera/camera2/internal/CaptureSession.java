...
final class CaptureSession implements CaptureSessionInterface {
            ...
            if (this.mState.ordinal() == 2) {
                ...
                FutureChain futureChainTransformAsync = FutureChain.from(opener.startWithDeferrableSurface(arrayList, 5000L)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.CaptureSession$$ExternalSyntheticLambda2
                    ...
                    public final ListenableFuture apply(Object obj) {
                        return this.f$0.m56lambda$open$0$androidxcameracamera2internalCaptureSession(sessionConfig, cameraDevice, (List) obj);
                    }
    ...
    public ListenableFuture<Void> m56lambda$open$0$androidxcameracamera2internalCaptureSession(List<Surface> list, SessionConfig sessionConfig, CameraDevice cameraDevice) {
        synchronized (this.mSessionLock) {
    ...
    */
    public com.google.common.util.concurrent.ListenableFuture<java.lang.Void> release(boolean r6) {
        /*
            ...
            monitor-enter(r3)
            androidx.camera.camera2.internal.CaptureSession$State r4 = r5.mState     // Catch: java.lang.Throwable -> La3
        ...
        L14:
            goto L87
        L15:
            androidx.camera.camera2.internal.SynchronizedCaptureSession r1 = r5.mSynchronizedCaptureSession     // Catch: java.lang.Throwable -> La3
            if (r1 == 0) goto L2c
            if (r6 == 0) goto L27
            r1.abortCaptures()     // Catch: android.hardware.camera2.CameraAccessException -> L1f java.lang.Throwable -> La3
            goto L27
        L1f:
            r6 = move-exception
            java.lang.String r1 = "CaptureSession"
            java.lang.String r2 = "Unable to abort captures."
            androidx.camera.core.Logger.e(r1, r2, r6)     // Catch: java.lang.Throwable -> La3
        L27:
            androidx.camera.camera2.internal.SynchronizedCaptureSession r6 = r5.mSynchronizedCaptureSession     // Catch: java.lang.Throwable -> La3
            r6.close()     // Catch: java.lang.Throwable -> La3
        L2c:
            androidx.camera.camera2.internal.CaptureSession$State r6 = androidx.camera.camera2.internal.CaptureSession.State.RELEASING     // Catch: java.lang.Throwable -> La3
            r5.setState(r6)     // Catch: java.lang.Throwable -> La3
            androidx.camera.camera2.internal.compat.workaround.RequestMonitor r6 = r5.mRequestMonitor     // Catch: java.lang.Throwable -> La3
            r6.stop()     // Catch: java.lang.Throwable -> La3
            androidx.camera.camera2.internal.SynchronizedCaptureSession$Opener r6 = r5.mSessionOpener     // Catch: java.lang.Throwable -> La3
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch: java.lang.Throwable -> La3
            r1.<init>(r0)     // Catch: java.lang.Throwable -> La3
            androidx.camera.camera2.internal.CaptureSession$State r0 = r5.mState     // Catch: java.lang.Throwable -> La3
            java.lang.StringBuilder r0 = r1.append(r0)     // Catch: java.lang.Throwable -> La3
            java.lang.String r0 = r0.toString()     // Catch: java.lang.Throwable -> La3
            androidx.core.util.Preconditions.checkNotNull(r6, r0)     // Catch: java.lang.Throwable -> La3
            androidx.camera.camera2.internal.SynchronizedCaptureSession$Opener r6 = r5.mSessionOpener     // Catch: java.lang.Throwable -> La3
            boolean r6 = r6.stop()     // Catch: java.lang.Throwable -> La3
            if (r6 == 0) goto L56
            r5.finishClose()     // Catch: java.lang.Throwable -> La3
            goto L87
        L56:
            com.google.common.util.concurrent.ListenableFuture<java.lang.Void> r6 = r5.mReleaseFuture     // Catch: java.lang.Throwable -> La3
            if (r6 != 0) goto L65
            androidx.camera.camera2.internal.CaptureSession$$ExternalSyntheticLambda1 r6 = new androidx.camera.camera2.internal.CaptureSession$$ExternalSyntheticLambda1     // Catch: java.lang.Throwable -> La3
            r6.<init>()     // Catch: java.lang.Throwable -> La3
            com.google.common.util.concurrent.ListenableFuture r6 = androidx.concurrent.futures.CallbackToFutureAdapter.getFuture(r6)     // Catch: java.lang.Throwable -> La3
            r5.mReleaseFuture = r6     // Catch: java.lang.Throwable -> La3
        L65:
            com.google.common.util.concurrent.ListenableFuture<java.lang.Void> r6 = r5.mReleaseFuture     // Catch: java.lang.Throwable -> La3
        ...
        L69:
            ...
            androidx.camera.camera2.internal.CaptureSession$State r1 = r5.mState     // Catch: java.lang.Throwable -> La3
            ...
            r6.stop()     // Catch: java.lang.Throwable -> La3
        L82:
            androidx.camera.camera2.internal.CaptureSession$State r6 = androidx.camera.camera2.internal.CaptureSession.State.RELEASED     // Catch: java.lang.Throwable -> La3
            r5.setState(r6)     // Catch: java.lang.Throwable -> La3
        L87:
            monitor-exit(r3)     // Catch: java.lang.Throwable -> La3
            r6 = 0
    ...
    /* synthetic */ Object m57lambda$release$1$androidxcameracamera2internalCaptureSession(CallbackToFutureAdapter.Completer completer) throws Exception {
        String str;
        synchronized (this.mSessionLock) {
    ...
    int issueRepeatingCaptureRequests(SessionConfig sessionConfig) {
        synchronized (this.mSessionLock) {
            ...
            try {
                ...
                if (sessionType == 1) {
                    return this.mSynchronizedCaptureSession.setRepeatingBurstRequests(synchronizedCaptureSession.createHighSpeedRequestList(captureRequestBuild), captureCallbackCreateMonitorListener);
                }
                return synchronizedCaptureSession.setSingleRepeatingRequest(captureRequestBuild, captureCallbackCreateMonitorListener);
                ...
                if (this.mStillCaptureFlow.shouldStopRepeatingBeforeCapture(arrayList, z)) {
                    ...
                    cameraBurstCaptureCallback.setCaptureSequenceCallback(new CameraBurstCaptureCallback.CaptureSequenceCallback() { // from class: androidx.camera.camera2.internal.CaptureSession$$ExternalSyntheticLambda0
                        ...
                        public final void onCaptureSequenceCompletedOrAborted(CameraCaptureSession cameraCaptureSession, int i, boolean z2) {
                            this.f$0.m54xac56a034(cameraCaptureSession, i, z2);
                        }
                    });
                }
    ...
    /* synthetic */ void m54xac56a034(CameraCaptureSession cameraCaptureSession, int i, boolean z) {
        synchronized (this.mSessionLock) {
            if (this.mState == State.OPENED) {
                issueRepeatingCaptureRequests(this.mSessionConfig);
            }
