...
public class TakePictureManagerImpl implements TakePictureManager, ForwardingImageProxy.OnImageCloseListener, TakePictureRequest.RetryControl {
    ...
    private void trackCurrentRequests(final RequestWithCallback requestWithCallback) {
        ...
        requestWithCallback.getCompleteFuture().addListener(new Runnable() { // from class: androidx.camera.core.imagecapture.TakePictureManagerImpl$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m170x56c14236(requestWithCallback);
            }
        }, CameraXExecutors.directExecutor());
    }

    /* JADX INFO: renamed from: lambda$trackCurrentRequests$0$androidx-camera-core-imagecapture-TakePictureManagerImpl, reason: not valid java name */
    /* synthetic */ void m169xc9d42b17() {
        this.mCapturingRequest = null;
        issueNextRequest();
    }

    /* JADX INFO: renamed from: lambda$trackCurrentRequests$1$androidx-camera-core-imagecapture-TakePictureManagerImpl, reason: not valid java name */
    /* synthetic */ void m170x56c14236(RequestWithCallback requestWithCallback) {
    ...
    private ListenableFuture<Void> submitCameraRequest(final CameraRequest cameraRequest) {
        ...
        Futures.addCallback(listenableFutureSubmitStillCaptureRequests, new FutureCallback<Void>() { // from class: androidx.camera.core.imagecapture.TakePictureManagerImpl.1
            ...
            public void onFailure(Throwable th) {
                ...
                if (z) {
                    takePictureManagerImpl.mImagePipeline.notifyCaptureError(TakePictureManager.CaptureError.of(id, (ImageCaptureException) th));
                } else {
                    takePictureManagerImpl.mImagePipeline.notifyCaptureError(TakePictureManager.CaptureError.of(id, new ImageCaptureException(2, "Failed to submit capture request", th)));
                }
                TakePictureManagerImpl.this.mImageCaptureControl.unlockFlashMode();
            }
