...
public final class CameraX {
        ...
        synchronized (this.mInitializeLock) {
            ...
            future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda3
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f$0.m138lambda$initInternal$0$androidxcameracoreCameraX(context, completer);
                }
            });
        }
        return future;
    ...
    /* synthetic */ Object m138lambda$initInternal$0$androidxcameracoreCameraX(Context context, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    private void initAndRetryRecursively(final Executor executor, final long j, final int i, final Context context, final CallbackToFutureAdapter.Completer<Void> completer) {
        executor.execute(new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda2
            ...
            public final void run() {
                this.f$0.m137lambda$initAndRetryRecursively$2$androidxcameracoreCameraX(context, executor, i, completer, j);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$initAndRetryRecursively$2$androidx-camera-core-CameraX, reason: not valid java name */
    /* synthetic */ void m137lambda$initAndRetryRecursively$2$androidxcameracoreCameraX(Context context, final Executor executor, final int i, final CallbackToFutureAdapter.Completer completer, final long j) {
        ...
        try {
            try {
                ...
                this.mCameraFactory = cameraFactoryProvider.newInstance(applicationContext, cameraThreadConfigCreate, availableCamerasLimiter, cameraOpenRetryMaxTimeoutInMillisWhileResuming, this.mCameraXConfig, streamSpecsCalculatorImpl);
                ...
                CameraDeviceSurfaceManager cameraDeviceSurfaceManagerNewInstance = deviceSurfaceManagerProvider.newInstance(applicationContext, this.mCameraFactory.getCameraManager(), this.mCameraFactory.getAvailableCameraIds());
                ...
                while (it.hasNext()) {
                    it.next().getCameraInfoInternal().setCameraUseCaseAdapterProvider(this.mCameraUseCaseAdapterProvider);
                }
                this.mCameraPresenceProvider.startup(this.mCameraFactory, this.mCameraRepository);
            ...
            if (!retryConfigOnRetryDecisionRequested.shouldRetry() || i >= Integer.MAX_VALUE) {
                ...
                HandlerCompat.postDelayed(this.mSchedulerHandler, new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m136lambda$initAndRetryRecursively$1$androidxcameracoreCameraX(executor, j, i, applicationContext, completer);
                    }
    ...
    /* synthetic */ void m136lambda$initAndRetryRecursively$1$androidxcameracoreCameraX(Executor executor, long j, int i, Context context, CallbackToFutureAdapter.Completer completer) {
        ...
        synchronized (this.mInitializeLock) {
            ...
            if (iOrdinal == 2 || iOrdinal == 3) {
                ...
                this.mShutdownInternalFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda4
                    @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                        return this.f$0.m140lambda$shutdownInternal$4$androidxcameracoreCameraX(completer);
                    }
                });
            }
    ...
    /* synthetic */ Object m140lambda$shutdownInternal$4$androidxcameracoreCameraX(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mCameraPresenceProvider.shutdown();
        this.mCameraRepository.deinit().addListener(new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m139lambda$shutdownInternal$3$androidxcameracoreCameraX(completer);
            }
    ...
    /* synthetic */ void m139lambda$shutdownInternal$3$androidxcameracoreCameraX(CallbackToFutureAdapter.Completer completer) {
