...
public abstract class Feature {
    ...
    public static final class Corner extends Feature {
        ...
        public Feature transformed$graphics_shapes_release(PointTransformer f) {
            ...
            return new Corner(CollectionsKt.build(listCreateListBuilder), PointKt.m421transformedso9K2fw(this.vertex, f), PointKt.m421transformedso9K2fw(this.roundedCenter, f), this.convex, null);
        }

        public String toString() {
            return "Corner: vertex=" + ((Object) FloatFloatPair.m329toStringimpl(this.vertex)) + ", center=" + ((Object) FloatFloatPair.m329toStringimpl(this.roundedCenter)) + ", convex=" + this.convex;
        }
    }
}
