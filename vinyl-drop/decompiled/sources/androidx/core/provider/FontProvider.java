                    ...
                    try {
                        if (cursorQuery != null && cursorQuery.getCount() > 0) {
                            ...
                            while (cursorQuery.moveToNext()) {
                                ...
                                arrayList2.add(FontsContractCompat.FontInfo.create(uriWithAppendedId, i3, columnIndex5 != -1 ? cursorQuery.getInt(columnIndex5) : LogSeverity.WARNING_VALUE, columnIndex6 != -1 && cursorQuery.getInt(columnIndex6) == 1, i2));
                                i = 0;
                            }
                        }
                        if (cursorQuery != null) {
