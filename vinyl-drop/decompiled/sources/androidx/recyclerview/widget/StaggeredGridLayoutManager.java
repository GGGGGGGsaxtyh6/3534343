...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    */
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (getChildCount() > 0) {
            ...
            for (int i = 0; i < this.mSpanCount; i++) {
                ...
                if (z) {
                    startLine = spanArr[i].getEndLine(Integer.MIN_VALUE);
                    if (startLine != Integer.MIN_VALUE) {
                        startAfterPadding = this.mPrimaryOrientation.getEndAfterPadding();
                        startLine -= startAfterPadding;
                    }
                } else {
                    startLine = spanArr[i].getStartLine(Integer.MIN_VALUE);
                    if (startLine != Integer.MIN_VALUE) {
    ...
    private void updateLayoutState(int i, RecyclerView.State state) {
        ...
        if (!isSmoothScrolling() || (targetScrollPosition = state.getTargetScrollPosition()) == -1) {
            ...
            boolean z3 = targetScrollPosition < i;
            OrientationHelper orientationHelper = this.mPrimaryOrientation;
            if (z2 == z3) {
    ...
    */
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        boolean z = staggeredGridLayoutManager.mShouldReverseLayout;
        ...
        while (layoutState.hasMore(state) && (r02.mLayoutState.mInfinite || !r02.mRemainingSpans.isEmpty())) {
            ...
            if (r02.isLayoutRTL() && r02.mOrientation == 1) {
                ...
                OrientationHelper orientationHelper2 = r02.mSecondaryOrientation;
                if (z3) {
                    decoratedMeasurement2 = orientationHelper2.getEndAfterPadding();
                } else {
                    decoratedMeasurement2 = orientationHelper2.getEndAfterPadding() - (((r02.mSpanCount - 1) - span2.mIndex) * r02.mSizePerSpan);
                }
            ...
            LayoutState layoutState2 = r0.mLayoutState;
            if (z4) {
                r0.updateAllRemainingSpans(layoutState2.mLayoutDirection, i2);
            } else {
                r0.updateRemainingSpans(span2, layoutState2.mLayoutDirection, i2);
            }
            ...
            if (r0.mLayoutState.mStopInFocusable && next.hasFocusable()) {
                ...
                BitSet bitSet = r0.mRemainingSpans;
                if (z5) {
                    bitSet.clear();
                } else {
        ...
        int i6 = r02.mLayoutState.mLayoutDirection;
        OrientationHelper orientationHelper3 = r02.mPrimaryOrientation;
        if (i6 == -1) {
            maxEnd = r02.mPrimaryOrientation.getStartAfterPadding() - r02.getMinStart(orientationHelper3.getStartAfterPadding());
        } else {
            maxEnd = r02.getMaxEnd(orientationHelper3.getEndAfterPadding()) - r02.mPrimaryOrientation.getEndAfterPadding();
        }
        if (maxEnd > 0) {
        ...
        if (preferLastSpan(iConvertFocusDirectionToLayoutDirection)) {
            for (int i4 = this.mSpanCount - 1; i4 >= 0; i4--) {
                if (i4 != span.mIndex) {
                    Span[] spanArr = this.mSpans;
                    if (z2) {
                        iFindLastPartiallyVisibleItemPosition2 = spanArr[i4].findFirstPartiallyVisibleItemPosition();
                    } else {
                        iFindLastPartiallyVisibleItemPosition2 = spanArr[i4].findLastPartiallyVisibleItemPosition();
                    }
            ...
            for (int i5 = 0; i5 < this.mSpanCount; i5++) {
                ...
                if (z2) {
                    iFindLastPartiallyVisibleItemPosition = spanArr2[i5].findFirstPartiallyVisibleItemPosition();
                } else {
                    iFindLastPartiallyVisibleItemPosition = spanArr2[i5].findLastPartiallyVisibleItemPosition();
                }
    ...
    class Span {
        ...
        public int findFirstVisibleItemPosition() {
            ...
            ArrayList<View> arrayList = this.mViews;
            if (z) {
                return findOneVisibleChild(arrayList.size() - 1, -1, false);
            }
            return findOneVisibleChild(0, arrayList.size(), false);
        }
        ...
        public int findFirstPartiallyVisibleItemPosition() {
            ...
            ArrayList<View> arrayList = this.mViews;
            if (z) {
                return findOnePartiallyVisibleChild(arrayList.size() - 1, -1, true);
            }
            return findOnePartiallyVisibleChild(0, arrayList.size(), true);
        }
        ...
        public int findFirstCompletelyVisibleItemPosition() {
            ...
            ArrayList<View> arrayList = this.mViews;
            if (z) {
                return findOneVisibleChild(arrayList.size() - 1, -1, true);
            }
            return findOneVisibleChild(0, arrayList.size(), true);
        }
    ...
    class AnchorInfo {
        ...
        void assignCoordinateFromPadding(int i) {
            ...
            StaggeredGridLayoutManager staggeredGridLayoutManager = StaggeredGridLayoutManager.this;
            if (z) {
                this.mOffset = staggeredGridLayoutManager.mPrimaryOrientation.getEndAfterPadding() - i;
            } else {
                this.mOffset = staggeredGridLayoutManager.mPrimaryOrientation.getStartAfterPadding() + i;
            }
        }
    }
}
