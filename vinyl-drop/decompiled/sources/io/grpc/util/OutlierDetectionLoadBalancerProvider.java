...
public final class OutlierDetectionLoadBalancerProvider extends LoadBalancerProvider {
    ...
    private NameResolver.ConfigOrError parseLoadBalancingPolicyConfigInternal(Map<String, ?> map) {
        ...
        NameResolver.ConfigOrError configOrErrorSelectLbPolicyFromList = ServiceConfigUtil.selectLbPolicyFromList(listUnwrapLoadBalancingConfigList, LoadBalancerRegistry.getDefaultRegistry());
        if (configOrErrorSelectLbPolicyFromList.getError() != null) {
            return configOrErrorSelectLbPolicyFromList;
        }
        builder.setChildPolicy((ServiceConfigUtil.PolicySelection) configOrErrorSelectLbPolicyFromList.getConfig());
