...
class OkHttpClientTransport implements ConnectionClientTransport, ExceptionHandlingFrameWriter.TransportExceptionHandler, OutboundFlowController.Transport {
    ...
    public Runnable start(ManagedClientTransport.Listener listener) {
        ...
        final AsyncSink asyncSinkSink = AsyncSink.sink(this.serializingExecutor, this, ModuleDescriptor.MODULE_VERSION);
            ...
            public void run() {
                ...
                try {
                    try {
                        ...
                        } else if (okHttpClientTransport2.proxiedAddr.getProxyAddress() instanceof InetSocketAddress) {
                        ...
                        okHttpClientTransport5.clientFrameHandler = okHttpClientTransport6.new ClientFrameHandler(okHttpClientTransport6.variant.newReader(bufferedSourceBuffer2, true));
                        synchronized (OkHttpClientTransport.this.lock) {
                        ...
                        okHttpClientTransport7.clientFrameHandler = okHttpClientTransport8.new ClientFrameHandler(okHttpClientTransport8.variant.newReader(bufferedSourceBuffer, true));
                        throw th;
                    }
                    ...
                    clientFrameHandler = okHttpClientTransport9.new ClientFrameHandler(okHttpClientTransport9.variant.newReader(bufferedSourceBuffer, true));
                    ...
                    clientFrameHandler = okHttpClientTransport10.new ClientFrameHandler(okHttpClientTransport10.variant.newReader(bufferedSourceBuffer, true));
                    okHttpClientTransport.clientFrameHandler = clientFrameHandler;
                }
            }
        });
    ...
    public Socket createHttpProxySocket(InetSocketAddress inetSocketAddress, InetSocketAddress inetSocketAddress2, String str, String str2) throws StatusException {
        ...
        try {
            ...
            if (address != null) {
                socketCreateSocket = socketFactory.createSocket(inetSocketAddress2.getAddress(), inetSocketAddress2.getPort());
            } else {
                socketCreateSocket = socketFactory.createSocket(inetSocketAddress2.getHostName(), inetSocketAddress2.getPort());
            }
            socket = socketCreateSocket;
            socket.setTcpNoDelay(true);
            ...
            if (statusLine.code < 200 || statusLine.code >= 300) {
                ...
                try {
                    ...
                    source.read(buffer, RealWebSocket.DEFAULT_MINIMUM_DEFLATE_SIZE);
                } catch (IOException e) {
    ...
    */
    ...
    class ClientFrameHandler implements FrameReader.Handler, Runnable {
        ...
        /* JADX WARN: Can't wrap try/catch for region: R(12:0|2|(7:3|55|4|5|(3:7|(3:65|9|68)(1:67)|66)(1:64)|40|41)|10|30|(1:15)|16|62|17|40|41|(2:(0)|(1:59))) */
        ...
        */
        ...
        public void data(boolean z, int i, BufferedSource bufferedSource, int i2, int i3) throws IOException {
            ...
            if (stream == null) {
                boolean zMayHaveCreatedStream = OkHttpClientTransport.this.mayHaveCreatedStream(i);
                ...
                if (zMayHaveCreatedStream) {
                    ...
                    okHttpClientTransport.onError(ErrorCode.PROTOCOL_ERROR, "Received data for unknown stream: " + i);
                    return;
                }
            } else {
                long j = i2;
        ...
        */
        public void windowUpdate(int r8, long r9) {
            /*
                ...
                io.grpc.okhttp.OkHttpClientTransport.access$2300(r0, r8, r9)
                return
            L19:
            ...
            L2a:
                ...
                java.lang.Object r8 = io.grpc.okhttp.OkHttpClientTransport.access$100(r8)
                monitor-enter(r8)
                io.grpc.okhttp.OkHttpClientTransport r0 = io.grpc.okhttp.OkHttpClientTransport.this
                if (r1 != 0) goto L41
                io.grpc.okhttp.OutboundFlowController r0 = io.grpc.okhttp.OkHttpClientTransport.access$200(r0)     // Catch: java.lang.Throwable -> L87
                r1 = 0
                int r9 = (int) r9     // Catch: java.lang.Throwable -> L87
                r0.windowUpdate(r1, r9)     // Catch: java.lang.Throwable -> L87
                monitor-exit(r8)     // Catch: java.lang.Throwable -> L87
                return
            L41:
                java.util.Map r0 = io.grpc.okhttp.OkHttpClientTransport.access$2600(r0)     // Catch: java.lang.Throwable -> L87
                ...
                io.grpc.okhttp.OkHttpClientStream r0 = (io.grpc.okhttp.OkHttpClientStream) r0     // Catch: java.lang.Throwable -> L87
                io.grpc.okhttp.OkHttpClientTransport r2 = io.grpc.okhttp.OkHttpClientTransport.this
                if (r0 == 0) goto L64
                io.grpc.okhttp.OutboundFlowController r2 = io.grpc.okhttp.OkHttpClientTransport.access$200(r2)     // Catch: java.lang.Throwable -> L87
                io.grpc.okhttp.OkHttpClientStream$TransportState r0 = r0.transportState()     // Catch: java.lang.Throwable -> L87
                io.grpc.okhttp.OutboundFlowController$StreamState r0 = r0.getOutboundFlowState()     // Catch: java.lang.Throwable -> L87
                int r9 = (int) r9     // Catch: java.lang.Throwable -> L87
                r2.windowUpdate(r0, r9)     // Catch: java.lang.Throwable -> L87
                goto L6c
            L64:
                boolean r9 = r2.mayHaveCreatedStream(r1)     // Catch: java.lang.Throwable -> L87
                if (r9 != 0) goto L6c
                r9 = 1
                goto L6d
            L6c:
            ...
            L6d:
                ...
                io.grpc.okhttp.OkHttpClientTransport.access$2300(r8, r9, r10)
            L86:
                return
            L87:
                r0 = move-exception
