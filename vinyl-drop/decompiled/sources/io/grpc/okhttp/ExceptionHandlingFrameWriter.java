...
final class ExceptionHandlingFrameWriter implements FrameWriter {
    ...
    public void ping(boolean z, int i, int i2) {
        ...
        if (z) {
            okHttpFrameLogger.logPingAck(OkHttpFrameLogger.Direction.OUTBOUND, (4294967295L & ((long) i2)) | (((long) i) << 32));
        } else {
            okHttpFrameLogger.logPing(OkHttpFrameLogger.Direction.OUTBOUND, (4294967295L & ((long) i2)) | (((long) i) << 32));
        }
        try {
