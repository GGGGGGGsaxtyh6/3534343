...
final class ToContinuation<T> implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            cancellableContinuation.resumeWith(Result.m773constructorimpl(AbstractResolvableFuture.getUninterruptibly(this.futureToObserve)));
            ...
            cancellableContinuation2.resumeWith(Result.m773constructorimpl(ResultKt.createFailure(thNonNullCause)));
        }
    }
}
