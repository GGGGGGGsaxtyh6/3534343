...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new Runnable() { // from class: androidx.recyclerview.widget.RecyclerView.1
            ...
            public void run() {
                ...
                boolean z = RecyclerView.this.mIsAttached;
                RecyclerView recyclerView = RecyclerView.this;
                if (!z) {
                    recyclerView.requestLayout();
                    return;
                }
                boolean z2 = recyclerView.mLayoutSuppressed;
        ...
        this.mViewInfoProcessCallback = new ViewInfoStore.ProcessCallback() { // from class: androidx.recyclerview.widget.RecyclerView.4
            ...
            public void processPersistent(ViewHolder viewHolder, ItemAnimator.ItemHolderInfo itemHolderInfo, ItemAnimator.ItemHolderInfo itemHolderInfo2) {
                ...
                boolean z = RecyclerView.this.mDataSetHasChangedAfterLayout;
                RecyclerView recyclerView = RecyclerView.this;
                if (z) {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:48:0x00dc A[PHI: r1
      0x00dc: PHI (r1v45 int) = (r1v26 int), (r1v49 int) binds: [B:41:0x00c7, B:46:0x00d8] A[DONT_GENERATE, DONT_INLINE]] */
    @Override // android.view.View
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked == 2) {
                ...
                if (this.mScrollState == 1) {
                    ...
                    iArr3[0] = 0;
                    iArr3[1] = 0;
                    if (dispatchNestedPreScroll(zCanScrollHorizontally ? i4 : 0, zCanScrollVertically ? i5 : 0, iArr3, this.mScrollOffset, 0)) {
                        int[] iArr4 = this.mReusableIntPair;
                        i4 -= iArr4[0];
                        i5 -= iArr4[1];
                    ...
                    if (scrollByInternal(zCanScrollHorizontally ? i4 : 0, zCanScrollVertically ? i5 : 0, motionEvent, 0)) {
                        getParent().requestDisallowInterceptTouchEvent(true);
                    }
                    GapWorker gapWorker = this.mGapWorker;
    ...
    */
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(View view, int i) {
            ...
            int iFindPositionOffset = recyclerView.mAdapterHelper.findPositionOffset(i);
        ...
        */
        ...
        void dispatchViewRecycled(ViewHolder viewHolder) {
            ...
            while (true) {
                ...
                recyclerView.mRecyclerListeners.get(i).onViewRecycled(viewHolder);
                i++;
            }
