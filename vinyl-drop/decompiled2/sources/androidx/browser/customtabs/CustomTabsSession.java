    ...
    public boolean requestPostMessageChannel(Uri uri) {
        try {
            ...
            if (pendingIntent != null) {
                return iCustomTabsService.requestPostMessageChannelWithExtras(this.mCallback, uri, createBundleWithId(null));
            }
            return iCustomTabsService.requestPostMessageChannel(this.mCallback, uri);
        } catch (RemoteException unused) {
            return false;
        }
    }
