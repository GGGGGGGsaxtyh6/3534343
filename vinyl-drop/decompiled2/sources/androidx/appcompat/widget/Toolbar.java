...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    /* JADX WARN: Removed duplicated region for block: B:110:0x0294 A[LOOP:0: B:108:0x0290->B:110:0x0294, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:114:0x02b0 A[LOOP:1: B:112:0x02ac->B:114:0x02b0, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:118:0x02d4  */
    /* JADX WARN: Removed duplicated region for block: B:124:0x02e5 A[LOOP:2: B:122:0x02e1->B:124:0x02e5, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:127:0x02a1 A[EDGE_INSN: B:127:0x02a1->B:111:0x02a1 BREAK  A[LOOP:0: B:108:0x0290->B:110:0x0294], SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:128:0x02bd A[EDGE_INSN: B:128:0x02bd->B:115:0x02bd BREAK  A[LOOP:1: B:112:0x02ac->B:114:0x02b0], SYNTHETIC] */
        ...
        if (shouldLayout(this.mNavButtonView)) {
            ...
            if (z3) {
                ...
                if (!zShouldLayout || zShouldLayout2) {
                    ...
                    if (z2) {
                        ...
                        if (zShouldLayout2) {
                            ...
                            this.mSubtitleTextView.layout(iMin - this.mSubtitleTextView.getMeasuredWidth(), i19, iMin, this.mSubtitleTextView.getMeasuredHeight() + i19);
                ...
                if (i13 >= iLayoutChildLeft2) {
                    iLayoutChildLeft2 = i24 > iMin ? i13 - (i24 - iMin) : i13;
                }
