...
public final class SharedPreferencesMigrationKt {
    ...
    static final class C00801 extends SuspendLambda implements Function2<Preferences, Continuation<? super Boolean>, Object> {
        final /* synthetic */ Set<String> $keysToMigrate;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00801(Set<String> set, Continuation<? super C00801> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00801 c00801 = new C00801(this.$keysToMigrate, continuation);
            c00801.L$0 = obj;
            return c00801;
        }
        ...
        public final Object invoke(Preferences preferences, Continuation<? super Boolean> continuation) {
            return ((C00801) create(preferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }
