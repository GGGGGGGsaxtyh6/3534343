...
public final class StorageConnectionKt {
    ...
    static final class C00772<T> extends SuspendLambda implements Function2<WriteScope<T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ T $value;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00772(T t, Continuation<? super C00772> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00772 c00772 = new C00772(this.$value, continuation);
            c00772.L$0 = obj;
            return c00772;
        }
        ...
        public final Object invoke(WriteScope<T> writeScope, Continuation<? super Unit> continuation) {
            return ((C00772) create(writeScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object writeData(StorageConnection<T> storageConnection, T t, Continuation<? super Unit> continuation) {
        Object objWriteScope = storageConnection.writeScope(new C00772(t, null), continuation);
