...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object objM2287getOrNullimpl = ChannelResult.m2287getOrNullimpl(((SimpleActor) this).messageQueue.mo2275tryReceivePtdJZtk());
                        if (objM2287getOrNullimpl != null) {
                            onUndeliveredElement.invoke((T) objM2287getOrNullimpl, th);
                            unit = Unit.INSTANCE;
                        } else {
                            unit = null;
                        }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo2268trySendJP2dKIU(msg);
        if (obj instanceof ChannelResult.Closed) {
            Throwable thM2286exceptionOrNullimpl = ChannelResult.m2286exceptionOrNullimpl(obj);
            if (thM2286exceptionOrNullimpl != null) {
                throw thM2286exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m2292isSuccessimpl(obj)) {
