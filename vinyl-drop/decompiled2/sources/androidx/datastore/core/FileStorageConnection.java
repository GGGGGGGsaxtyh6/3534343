...
public final class FileStorageConnection<T> implements StorageConnection<T> {
    ...
    static final class C00741 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00741(FileStorageConnection<T> fileStorageConnection, Continuation<? super C00741> continuation) {
            super(continuation);
            this.this$0 = fileStorageConnection;
        }
    ...
    public Object writeScope(Function2<? super WriteScope<T>, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C00741) {
            ...
            if ((c00741.label & Integer.MIN_VALUE) != 0) {
                ...
                c00741 = new C00741(this, continuation);
            }
        }
                ...
                try {
                    try {
                        if (i == 0) {
                            ...
                            c00741.L$0 = this;
                            c00741.L$1 = function2;
                            c00741.L$2 = mutex2;
                            c00741.label = 1;
                            if (mutex2.lock(null, c00741) != coroutine_suspended) {
                        ...
                        if (i != 1) {
                            ...
                            closeable = (Closeable) c00741.L$3;
                            File file3 = (File) c00741.L$2;
                            mutex = (Mutex) c00741.L$1;
                            fileStorageConnection2 = (FileStorageConnection) c00741.L$0;
                            try {
                                ResultKt.throwOnFailure(obj);
                                file2 = file3;
                        ...
                        Mutex mutex3 = (Mutex) c00741.L$2;
                        Function2<? super WriteScope<T>, ? super Continuation<? super Unit>, ? extends Object> function22 = (Function2) c00741.L$1;
                        fileStorageConnection = (FileStorageConnection) c00741.L$0;
                        ResultKt.throwOnFailure(obj);
                        mutex = mutex3;
                        function2 = function22;
                        c00741.L$0 = fileStorageConnection;
                        c00741.L$1 = mutex;
                        c00741.L$2 = file;
                        c00741.L$3 = fileWriteScope;
                        c00741.label = 2;
                        if (function2.invoke(fileWriteScope, c00741) != coroutine_suspended) {
                            file2 = file;
