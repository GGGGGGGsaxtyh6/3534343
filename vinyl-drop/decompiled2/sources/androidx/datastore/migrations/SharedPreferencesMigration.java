    ...
    public Object shouldMigrate(T t, Continuation<? super Boolean> continuation) throws Throwable {
        ...
        if (continuation instanceof C00791) {
            ...
            if ((c00791.label & Integer.MIN_VALUE) != 0) {
                ...
                c00791 = new C00791(this, continuation);
            }
        }
        Object objInvoke = c00791.result;
        ...
        if (i == 0) {
            ...
            c00791.L$0 = this;
            c00791.label = 1;
            objInvoke = function2.invoke(t, c00791);
            ...
            sharedPreferencesMigration = (SharedPreferencesMigration) c00791.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
