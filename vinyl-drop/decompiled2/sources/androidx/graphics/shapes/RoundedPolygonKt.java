...
public final class RoundedPolygonKt {
    ...
    public static final RoundedPolygon RoundedPolygon(float[] vertices, CornerRounding rounding, List<CornerRounding> list, float f, float f2) {
        ...
        while (i4 < length) {
            ...
            int i7 = (i6 % length) * 2;
            int i8 = i4 * 2;
            arrayList2.add(new RoundedCorner(FloatFloatPair.m322constructorimpl(vertices[i5], vertices[i5 + 1]), FloatFloatPair.m322constructorimpl(vertices[i8], vertices[i8 + 1]), FloatFloatPair.m322constructorimpl(vertices[i7], vertices[i7 + 1]), cornerRounding2, null));
            i4 = i6;
        }
        ...
        while (i3 < length) {
            ...
            int i15 = i14 % length;
            int i16 = i3 * 2;
            long jM322constructorimpl = FloatFloatPair.m322constructorimpl(vertices[i16], vertices[i16 + i2]);
            int i17 = (((i3 + length) - i2) % length) * i;
            long jM322constructorimpl2 = FloatFloatPair.m322constructorimpl(vertices[i17], vertices[i17 + i2]);
            int i18 = i15 * 2;
            arrayList5.add(new Feature.Corner((List) arrayList.get(i3), jM322constructorimpl, ((RoundedCorner) arrayList2.get(i3)).getCenter(), PointKt.m405clockwiseybeJwSQ(PointKt.m417minusybeJwSQ(jM322constructorimpl, jM322constructorimpl2), PointKt.m417minusybeJwSQ(FloatFloatPair.m322constructorimpl(vertices[i18], vertices[i18 + i2]), jM322constructorimpl)), null));
        ...
        if (f == Float.MIN_VALUE || f2 == Float.MIN_VALUE) {
            ...
            jCalculateCenter = FloatFloatPair.m322constructorimpl(f, f2);
        }
        return new RoundedPolygon(arrayList5, Float.intBitsToFloat((int) (jCalculateCenter >> 32)), Float.intBitsToFloat((int) (jCalculateCenter & 4294967295L)));
    }
    ...
    private static final long calculateCenter(float[] fArr) {
        ...
        float f3 = 2;
        return FloatFloatPair.m322constructorimpl((f / fArr.length) / f3, (f2 / fArr.length) / f3);
    }
    ...
    private static final float[] verticesFromNumVerts(int i, float f, float f2, float f3) {
        ...
        while (i2 < i) {
            float f4 = f;
            long jM418plusybeJwSQ = PointKt.m418plusybeJwSQ(Utils.m434radialToCartesianL6JJ3z0$default(f4, (Utils.getFloatPi() / i) * 2 * i2, 0L, 4, null), FloatFloatPair.m322constructorimpl(f2, f3));
            int i4 = i3 + 1;
            fArr[i3] = PointKt.m414getXDnnuFBc(jM418plusybeJwSQ);
            i3 += 2;
            fArr[i4] = PointKt.m415getYDnnuFBc(jM418plusybeJwSQ);
            i2++;
            f = f4;
        }
        return fArr;
