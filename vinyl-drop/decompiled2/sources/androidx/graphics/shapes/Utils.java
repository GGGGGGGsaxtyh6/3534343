...
public final class Utils {
    ...
    private static final long Zero = FloatFloatPair.m322constructorimpl(0.0f, 0.0f);
    ...
    public static final long directionVector(float f, float f2) {
        ...
        return FloatFloatPair.m322constructorimpl(f / fDistance, f2 / fDistance);
    }

    public static final long directionVector(float f) {
        double d = f;
        return FloatFloatPair.m322constructorimpl((float) Math.cos(d), (float) Math.sin(d));
    }
    ...
    public static /* synthetic */ long m434radialToCartesianL6JJ3z0$default(float f, float f2, long j, int i, Object obj) {
        if ((i & 4) != 0) {
            j = Zero;
        }
        return m433radialToCartesianL6JJ3z0(f, f2, j);
    }

    /* JADX INFO: renamed from: radialToCartesian-L6JJ3z0, reason: not valid java name */
    public static final long m433radialToCartesianL6JJ3z0(float f, float f2, long j) {
        return PointKt.m418plusybeJwSQ(PointKt.m420timesso9K2fw(directionVector(f2), f), j);
    }

    /* JADX INFO: renamed from: rotate90-DnnuFBc, reason: not valid java name */
    public static final long m435rotate90DnnuFBc(long j) {
        return FloatFloatPair.m322constructorimpl(-PointKt.m415getYDnnuFBc(j), PointKt.m414getXDnnuFBc(j));
    }
