...
public final class MutableCubic extends Cubic {
    ...
    private final void transformOnePoint(PointTransformer f, int ix) {
        int i = ix + 1;
        long jMo423transformXgqJiTY = f.mo423transformXgqJiTY(getPoints()[ix], getPoints()[i]);
        getPoints()[ix] = Float.intBitsToFloat((int) (jMo423transformXgqJiTY >> 32));
        getPoints()[i] = Float.intBitsToFloat((int) (jMo423transformXgqJiTY & 4294967295L));
    }
