...
public final class CredentialProviderPlayServicesImpl implements CredentialProvider {
    ...
    public void onClearCredential(ClearCredentialStateRequest request, final CancellationSignal cancellationSignal, final Executor executor, final CredentialManagerCallback<Void, ClearCredentialException> callback) {
        ...
        final Function1<Void, Unit> function1 = new Function1<Void, Unit>() { // from class: androidx.credentials.playservices.CredentialProviderPlayServicesImpl.onClearCredential.1
            ...
            static final class C00061 extends Lambda implements Function0<Unit> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C00061(Executor executor, CredentialManagerCallback<Void, ClearCredentialException> credentialManagerCallback) {
                    super(0);
                ...
                public final void invoke2() {
                    ...
                    executor.execute(new Runnable() { // from class: androidx.credentials.playservices.CredentialProviderPlayServicesImpl$onClearCredential$1$1$$ExternalSyntheticLambda0
                        ...
                        public final void run() {
                            CredentialProviderPlayServicesImpl.AnonymousClass1.C00061.invoke$lambda$0(credentialManagerCallback);
                        }
                    });
                }

                static final void invoke$lambda$0(CredentialManagerCallback callback) {
                    Intrinsics.checkNotNullParameter(callback, "$callback");
            ...
            public final void invoke2(Void r5) {
                CredentialProviderPlayServicesImpl.INSTANCE.cancellationReviewerWithCallback$credentials_play_services_auth_release(cancellationSignal, new C00061(executor, callback));
            }
        };
    ...
    static final void onClearCredential$lambda$0(Function1 tmp0, Object obj) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        tmp0.invoke(obj);
    }

    static final void onClearCredential$lambda$2(CredentialProviderPlayServicesImpl this$0, CancellationSignal cancellationSignal, Executor executor, CredentialManagerCallback callback, Exception e) {
