...
public class SupportedOutputSizesSorter {
    ...
    public List<Size> getSortedSupportedOutputSizes(UseCaseConfig<?> useCaseConfig) {
        ...
        List<Size> listApplyHighResolutionSettings = !useCaseConfig.isHighResolutionDisabled(false) ? applyHighResolutionSettings(resolutionCandidateList, resolutionSelector, useCaseConfig.getInputFormat()) : resolutionCandidateList;
        Logger.d(TAG, "useCaseConfig = " + useCaseConfig + ", candidateSizes = " + listApplyHighResolutionSettings);
        return sortSupportedOutputSizesByResolutionSelector(imageOutputConfig.getResolutionSelector(), listApplyHighResolutionSettings, maxResolution, targetRotation, this.mFullFovRatio, this.mSensorOrientation, this.mLensFacing);
    }
