...
public final class Recording implements AutoCloseable {
    ...
    static Recording from(PendingRecording pendingRecording, long j) {
        ...
        return new Recording(pendingRecording.getRecorder(), j, pendingRecording.getOutputOptions(), pendingRecording.getIsPersistent(), false);
    }

    static Recording createFinalizedFrom(PendingRecording pendingRecording, long j) {
        Preconditions.checkNotNull(pendingRecording, "The given PendingRecording cannot be null.");
        return new Recording(pendingRecording.getRecorder(), j, pendingRecording.getOutputOptions(), pendingRecording.getIsPersistent(), true);
    }
