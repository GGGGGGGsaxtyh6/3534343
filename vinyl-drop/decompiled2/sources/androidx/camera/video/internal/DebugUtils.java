...
public final class DebugUtils {
    ...
    public static String getCsdHex(MediaFormat mediaFormat) {
        ...
        if (mediaFormat.containsKey(EncoderConfig.KEY_CSD_1)) {
            sb.append(", csd-1 = ").append(byteBufferToHex(mediaFormat.getByteBuffer(EncoderConfig.KEY_CSD_1)));
        }
        if (mediaFormat.containsKey(EncoderConfig.KEY_CSD_2)) {
            sb.append(", csd-2 = ").append(byteBufferToHex(mediaFormat.getByteBuffer(EncoderConfig.KEY_CSD_2)));
        }
        sb.append("}");
        return sb.toString();
    }
