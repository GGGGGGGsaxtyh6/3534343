...
public final class VideoConfigUtil {
    ...
    static CaptureEncodeRates resolveFrameRates(VideoSpec videoSpec, Range<Integer> range) {
        int iIntValue = SurfaceRequest.FRAME_RATE_RANGE_UNSPECIFIED.equals(range) ? 30 : ((Integer) range.getUpper()).intValue();
        ...
        boolean zEquals = SurfaceRequest.FRAME_RATE_RANGE_UNSPECIFIED.equals(range);
        Object obj = range;
        if (zEquals) {
            obj = "<UNSPECIFIED>";
        }
