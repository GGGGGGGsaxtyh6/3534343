...
public class Camera2CameraControlImpl implements CameraControlInternal {
    ...
    public void addInteropConfig(Config config) {
        this.mCamera2CameraControl.addCaptureRequestOptions(CaptureRequestOptions.Builder.from(config).build()).addListener(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda8
    ...
    public void clearInteropConfig() {
        this.mCamera2CameraControl.clearCaptureRequestOptions().addListener(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
    ...
    @Override // androidx.camera.core.CameraControl
    public ListenableFuture<Void> enableLowLightBoostAsync(boolean z) {
        if (!isControlInUse()) {
            return Futures.immediateFailedFuture(new CameraControl.OperationCanceledException("Camera is not active."));
        }
        return Futures.nonCancellationPropagating(this.mLowLightBoostControl.enableLowLightBoost(z));
    }

    private ListenableFuture<Void> waitForSessionUpdateId(final long j) {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda10
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m14xf5e6a45(j, completer);
            }
        });
    }
    ...
    /* synthetic */ Object m14xf5e6a45(final long j, final CallbackToFutureAdapter.Completer completer) throws Exception {
        addCaptureResultListener(new CaptureResultListener() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda4
    ...
    @Override // androidx.camera.core.CameraControl
    public ListenableFuture<Void> setTorchStrengthLevel(int i) {
        if (!isControlInUse()) {
            return Futures.immediateFailedFuture(new CameraControl.OperationCanceledException("Camera is not active."));
        }
        if (!this.mCameraCharacteristics.isTorchStrengthLevelSupported()) {
            return Futures.immediateFailedFuture(new UnsupportedOperationException("The device doesn't support configuring torch strength level."));
        }
        if (i < 1 || i > this.mCameraCharacteristics.getMaxTorchStrengthLevel()) {
            return Futures.immediateFailedFuture(new IllegalArgumentException("The specified torch strength is not within the valid range."));
        }
        return Futures.nonCancellationPropagating(this.mTorchControl.setTorchStrengthLevel(Math.min(i, this.mCameraCharacteristics.getMaxTorchStrengthLevel())));
    }

    void setTorchStrengthLevelInternal(int i) {
        this.mTorchStrength = i;
        if (isTorchOn()) {
    ...
    public ListenableFuture<List<Void>> submitStillCaptureRequests(final List<CaptureConfig> list, final int i, final int i2) {
        ...
        return FutureChain.from(Futures.nonCancellationPropagating(this.mFlashModeChangeSessionUpdateFuture)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda6
            ...
            public final ListenableFuture apply(Object obj) {
                return this.f$0.m11xc07d4a5a(list, i, flashMode, i2, (Void) obj);
            }
        }, this.mExecutor);
    }
    ...
    /* synthetic */ ListenableFuture m11xc07d4a5a(List list, int i, int i2, int i3, Void r5) throws Exception {
    ...
    public ListenableFuture<CameraCapturePipeline> getCameraCapturePipelineAsync(final int i, final int i2) {
        ...
        final int flashMode = getFlashMode();
        return FutureChain.from(Futures.nonCancellationPropagating(this.mFlashModeChangeSessionUpdateFuture)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda9
            @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
            public final ListenableFuture apply(Object obj) {
                return this.f$0.m7x7ab018f6(i, flashMode, i2, (Void) obj);
            }
        }, this.mExecutor);
    }
    ...
    /* synthetic */ ListenableFuture m7x7ab018f6(int i, int i2, int i3, Void r4) throws Exception {
    ...
    public ListenableFuture<Void> updateSessionConfigAsync() {
        return Futures.nonCancellationPropagating(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda12
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m13x6775df50(completer);
            }
        }));
    }
    ...
    /* synthetic */ Object m13x6775df50(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m12x56c0128f(completer);
            }
        });
    ...
    /* synthetic */ void m12x56c0128f(CallbackToFutureAdapter.Completer completer) {
    ...
    void addSessionCameraCaptureCallback(final Executor executor, final CameraCaptureCallback cameraCaptureCallback) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m6x48c3417b(executor, cameraCaptureCallback);
            }
        });
    }
    ...
    /* synthetic */ void m6x48c3417b(Executor executor, CameraCaptureCallback cameraCaptureCallback) {
    ...
    void removeSessionCameraCaptureCallback(final CameraCaptureCallback cameraCaptureCallback) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m10xd0890cf9(cameraCaptureCallback);
            }
        });
    }
    ...
    /* synthetic */ void m10xd0890cf9(CameraCaptureCallback cameraCaptureCallback) {
        ...
        if (this.mIsLowLightBoostOn) {
            ...
            if (Build.VERSION.SDK_INT >= 35) {
                if (this.mTorchState == 1) {
                    builder.setCaptureRequestOptionWithPriority(CaptureRequest.FLASH_STRENGTH_LEVEL, Integer.valueOf(this.mTorchStrength), Config.OptionPriority.REQUIRED);
                } else if (this.mTorchState == 2) {
                    builder.setCaptureRequestOptionWithPriority(CaptureRequest.FLASH_STRENGTH_LEVEL, Integer.valueOf(this.mCameraCharacteristics.getDefaultTorchStrengthLevel()), Config.OptionPriority.REQUIRED);
                }
            }
        } else {
    ...
    private boolean isRepeatingRequestAvailable() {
        try {
            return ((Boolean) CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda0
                @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f$0.m9x6c7e111d(completer);
                }
            }).get()).booleanValue();
    ...
    /* JADX INFO: renamed from: lambda$isRepeatingRequestAvailable$10$androidx-camera-camera2-internal-Camera2CameraControlImpl, reason: not valid java name */
    /* synthetic */ void m8x5bc8445c(CallbackToFutureAdapter.Completer completer) {
        completer.set(Boolean.valueOf(this.mIsRepeatingRequestAvailable));
    }

    /* JADX INFO: renamed from: lambda$isRepeatingRequestAvailable$11$androidx-camera-camera2-internal-Camera2CameraControlImpl, reason: not valid java name */
    /* synthetic */ Object m9x6c7e111d(final CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m8x5bc8445c(completer);
                }
            });
    ...
    static final class CameraControlSessionCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public void onCaptureCompleted(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, final TotalCaptureResult totalCaptureResult) {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$CameraControlSessionCallback$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m15xf57ef947(totalCaptureResult);
                }
            });
        }
        ...
        /* synthetic */ void m15xf57ef947(TotalCaptureResult totalCaptureResult) {
