...
public final class CompletionStateKt {
    public static final <T> Object toState(Object obj) {
        ...
        return thM776exceptionOrNullimpl == null ? obj : new CompletedExceptionally(thM776exceptionOrNullimpl, false, 2, null);
    }
    ...
    public static final <T> Object toState(Object obj, CancellableContinuation<?> cancellableContinuation) {
        ...
        if (DebugKt.getRECOVER_STACK_TRACES()) {
            ...
            if (cancellableContinuation2 instanceof CoroutineStackFrame) {
                thM776exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(thM776exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation2);
            }
        }
        return new CompletedExceptionally(thM776exceptionOrNullimpl, false, 2, null);
    }
    ...
    public static final <T> Object recoverResult(Object obj, Continuation<? super T> continuation) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return Result.m773constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame));
        }
