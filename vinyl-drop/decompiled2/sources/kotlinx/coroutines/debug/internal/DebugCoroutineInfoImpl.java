    ...
    */
    public final Object yieldFrames(SequenceScope<? super StackTraceElement> sequenceScope, CoroutineStackFrame coroutineStackFrame, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            DebugCoroutineInfoImpl debugCoroutineInfoImpl2 = (DebugCoroutineInfoImpl) c01561.L$2;
            CoroutineStackFrame coroutineStackFrame2 = (CoroutineStackFrame) c01561.L$1;
            SequenceScope<? super StackTraceElement> sequenceScope2 = (SequenceScope) c01561.L$0;
            ResultKt.throwOnFailure(obj);
            ...
            if (callerFrame == null) {
                ...
                if (stackTraceElement != null) {
                    c01561.L$0 = sequenceScope;
                    c01561.L$1 = callerFrame;
                    c01561.L$2 = debugCoroutineInfoImpl;
                    c01561.label = 1;
                    if (sequenceScope.yield(stackTraceElement, c01561) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
