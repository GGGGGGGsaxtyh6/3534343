    ...
    public static final Object fixedPeriodTicker(long j, long j2, SendChannel<? super Unit> sendChannel, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C01551) {
            ...
            if ((c01551.label & Integer.MIN_VALUE) != 0) {
                ...
                c01551 = new C01551(continuation);
            }
        }
        ...
        if (i == 0) {
            ...
            c01551.L$0 = sendChannel2;
            j3 = j;
            c01551.J$0 = j3;
            c01551.J$1 = jNanoTime;
            c01551.label = 1;
            if (DelayKt.delay(j2, c01551) != coroutine_suspended) {
                j4 = jNanoTime;
            }
        ...
        if (i != 1) {
            if (i == 2) {
                j6 = c01551.J$1;
                j7 = c01551.J$0;
                sendChannel3 = (SendChannel) c01551.L$0;
                ResultKt.throwOnFailure(obj);
                ...
                c01551.L$0 = sendChannel2;
                c01551.J$0 = j8;
                c01551.J$1 = jDelayToNanos;
                c01551.label = 2;
                if (sendChannel2.send(unit, c01551) != coroutine_suspended) {
                }
                return coroutine_suspended;
            }
            if (i == 3) {
        ...
        j4 = c01551.J$1;
        long j13 = c01551.J$0;
        SendChannel sendChannel4 = (SendChannel) c01551.L$0;
        ResultKt.throwOnFailure(obj);
