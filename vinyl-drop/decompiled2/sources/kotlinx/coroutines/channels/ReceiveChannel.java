...
public interface ReceiveChannel<E> {
    ...
    Object mo2274receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo2275tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2275tryReceivePtdJZtk = receiveChannel.mo2275tryReceivePtdJZtk();
            if (ChannelResult.m2292isSuccessimpl(objMo2275tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2288getOrThrowimpl(objMo2275tryReceivePtdJZtk);
            }
            Throwable thM2286exceptionOrNullimpl = ChannelResult.m2286exceptionOrNullimpl(objMo2275tryReceivePtdJZtk);
            if (thM2286exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2286exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                objMo2274receiveCatchingJP2dKIU = receiveChannel.mo2274receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m2287getOrNullimpl(objMo2274receiveCatchingJP2dKIU);
        }
