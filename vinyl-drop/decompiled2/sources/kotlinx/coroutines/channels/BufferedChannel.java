...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo2274receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m2272receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
        ...
        while (true) {
            ...
            if (channelSegment.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m2295closedJP2dKIU(getSendException());
                }
            } else {
            ...
            if (iUpdateCellSend == 0) {
                channelSegment.cleanPrev();
                return ChannelResult.INSTANCE.m2297successJP2dKIU(Unit.INSTANCE);
            }
            if (iUpdateCellSend == 1) {
                return ChannelResult.INSTANCE.m2297successJP2dKIU(Unit.INSTANCE);
            }
    ...
    protected final Object m2276trySendDropOldestJP2dKIU(E element) {
        ChannelSegment channelSegmentFindSegmentSend;
        int i;
        BufferedChannel<E> bufferedChannel;
    ...
    private final boolean tryResumeReceiver(Object obj, E e) {
        ...
        if (obj instanceof ReceiveCatching) {
            ...
            ChannelResult channelResultM2282boximpl = ChannelResult.m2282boximpl(ChannelResult.INSTANCE.m2297successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            return BufferedChannelKt.tryResume0(cancellableContinuationImpl, channelResultM2282boximpl, (Function3) (function1 != null ? bindCancellationFunResult(function1) : null));
        }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m773constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    */
    static /* synthetic */ <E> Object m2272receiveCatchingJP2dKIU$suspendImpl(BufferedChannel<E> bufferedChannel, Continuation<? super ChannelResult<? extends E>> continuation) throws Throwable {
            ...
            if (objUpdateCellReceive != BufferedChannelKt.SUSPEND) {
                if (objUpdateCellReceive != BufferedChannelKt.FAILED) {
                    if (objUpdateCellReceive == BufferedChannelKt.SUSPEND_NO_WAITER) {
                        ...
                        Object objM2273receiveCatchingOnNoWaiterSuspendGKJJFZk = bufferedChannel2.m2273receiveCatchingOnNoWaiterSuspendGKJJFZk(channelSegment, i2, andIncrement, bufferedChannel$receiveCatching$12);
                        return objM2273receiveCatchingOnNoWaiterSuspendGKJJFZk == coroutine_suspended ? coroutine_suspended : objM2273receiveCatchingOnNoWaiterSuspendGKJJFZk;
                    }
                    channelSegment.cleanPrev();
                    return ChannelResult.INSTANCE.m2297successJP2dKIU(objUpdateCellReceive);
                }
                if (andIncrement < bufferedChannel2.getSendersCounter$kotlinx_coroutines_core()) {
                    channelSegment.cleanPrev();
                }
        ...
        return ChannelResult.INSTANCE.m2295closedJP2dKIU(bufferedChannel.getCloseCause());
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object m2273receiveCatchingOnNoWaiterSuspendGKJJFZk(ChannelSegment<E> channelSegment, int i, long j, Continuation<? super ChannelResult<? extends E>> continuation) throws Throwable {
        BufferedChannel$receiveCatchingOnNoWaiterSuspend$1 bufferedChannel$receiveCatchingOnNoWaiterSuspend$1;
        ChannelResult channelResultM2282boximpl;
        ChannelSegment channelSegment2;
                    ...
                    try {
                        if (objUpdateCellReceive != BufferedChannelKt.SUSPEND) {
                            ...
                            if (objUpdateCellReceive == BufferedChannelKt.FAILED) {
                                ...
                                while (true) {
                                    ...
                                    if (objUpdateCellReceive2 != BufferedChannelKt.SUSPEND) {
                                        if (objUpdateCellReceive2 == BufferedChannelKt.FAILED) {
                                            ...
                                            channelSegment2.cleanPrev();
                                            channelResultM2282boximpl = ChannelResult.m2282boximpl(ChannelResult.INSTANCE.m2297successJP2dKIU(objUpdateCellReceive2));
                                            Function1<E, Unit> function1 = this.onUndeliveredElement;
                                            if (function1 != null) {
                                ...
                                channelSegment.cleanPrev();
                                channelResultM2282boximpl = ChannelResult.m2282boximpl(ChannelResult.INSTANCE.m2297successJP2dKIU(objUpdateCellReceive));
                                Function1<E, Unit> function12 = this.onUndeliveredElement;
                                if (function12 != null) {
                                    kFunctionBindCancellationFunResult = bindCancellationFunResult(function12);
                                }
                            }
                            orCreateCancellableContinuation.resume(channelResultM2282boximpl, (Function3<? super Throwable, ? super ChannelResult, ? super CoroutineContext, Unit>) kFunctionBindCancellationFunResult);
                        } else {
    ...
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m773constructorimpl(ChannelResult.m2282boximpl(ChannelResult.INSTANCE.m2295closedJP2dKIU(getCloseCause()))));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* JADX INFO: renamed from: tryReceive-PtdJZtk, reason: not valid java name */
    public Object mo2275tryReceivePtdJZtk() {
        ChannelSegment channelSegment;
        long j = receivers$volatile$FU.get(this);
        long j2 = sendersAndCloseStatus$volatile$FU.get(this);
        if (isClosedForReceive0(j2)) {
            return ChannelResult.INSTANCE.m2295closedJP2dKIU(getCloseCause());
        }
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m2282boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m2295closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m2297successJP2dKIU(selectResult));
    }
    ...
    private final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (closeCause == null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m773constructorimpl(false));
                return;
            }
            ...
            cancellableContinuationImpl2.resumeWith(Result.m773constructorimpl(ResultKt.createFailure(closeCause)));
        }
    ...
    */
    private final void removeUnprocessedElements(ChannelSegment<E> lastSegment) {
        ...
        Object objM2321constructorimpl$default = InlineList.m2321constructorimpl$default(null, 1, null);
        loop0: do {
                    ...
                    if (state$kotlinx_coroutines_core != BufferedChannelKt.BUFFERED) {
                        if (state$kotlinx_coroutines_core == BufferedChannelKt.IN_BUFFER || state$kotlinx_coroutines_core == null) {
                            ...
                            if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                ...
                                objM2321constructorimpl$default = InlineList.m2326plusFjFbRPM(objM2321constructorimpl$default, waiter);
        ...
        if (objM2321constructorimpl$default != null) {
            if (!(objM2321constructorimpl$default instanceof ArrayList)) {
                resumeSenderOnCancelledChannel((Waiter) objM2321constructorimpl$default);
            } else {
                Intrinsics.checkNotNull(objM2321constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>");
                ArrayList arrayList = (ArrayList) objM2321constructorimpl$default;
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
            ...
            for (int i = BufferedChannelKt.SEGMENT_SIZE - 1; -1 < i; i--) {
                ...
                while (true) {
                    ...
                    if (state$kotlinx_coroutines_core == null || state$kotlinx_coroutines_core == BufferedChannelKt.IN_BUFFER) {
                        ...
                        if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            objM2321constructorimpl$default = InlineList.m2326plusFjFbRPM(objM2321constructorimpl$default, ((WaiterEB) state$kotlinx_coroutines_core).waiter);
                        ...
                        if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            objM2321constructorimpl$default = InlineList.m2326plusFjFbRPM(objM2321constructorimpl$default, state$kotlinx_coroutines_core);
                            lastSegment.onCancelledRequest(i, true);
                            break;
                        }
                    }
        ...
        if (objM2321constructorimpl$default != null) {
            if (!(objM2321constructorimpl$default instanceof ArrayList)) {
                resumeReceiverOnClosedChannel((Waiter) objM2321constructorimpl$default);
                return;
            }
            Intrinsics.checkNotNull(objM2321constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>");
            ArrayList arrayList = (ArrayList) objM2321constructorimpl$default;
    ...
    private final void resumeWaiterOnClosedChannel(Waiter waiter, boolean z) {
        if (waiter instanceof SendBroadcast) {
            ...
            Result.Companion companion = Result.INSTANCE;
            cont.resumeWith(Result.m773constructorimpl(false));
            return;
        }
        if (waiter instanceof CancellableContinuation) {
            Continuation continuation = (Continuation) waiter;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m773constructorimpl(ResultKt.createFailure(z ? getReceiveException() : getSendException())));
            ...
            cancellableContinuationImpl.resumeWith(Result.m773constructorimpl(ChannelResult.m2282boximpl(ChannelResult.INSTANCE.m2295closedJP2dKIU(getCloseCause()))));
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m2338isClosedimpl(objFindSegmentInternal)) {
                Segment segmentM2336getSegmentimpl = SegmentOrClosed.m2336getSegmentimpl(objFindSegmentInternal);
                while (true) {
                    Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                    if (segment.id >= segmentM2336getSegmentimpl.id) {
                        break loop0;
                    }
                    if (!segmentM2336getSegmentimpl.tryIncPointers$kotlinx_coroutines_core()) {
                        break;
                    }
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, segment, segmentM2336getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
                    } else if (segmentM2336getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
                        segmentM2336getSegmentimpl.remove();
                    }
                }
            } else {
                break;
        ...
        ChannelSegment<E> channelSegment = (ChannelSegment) SegmentOrClosed.m2336getSegmentimpl(objFindSegmentInternal);
    ...
    */
    ...
    /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function3<Throwable, ChannelResult<? extends E>, CoroutineContext, Unit> {
        ...
        public /* bridge */ /* synthetic */ Unit invoke(Throwable th, Object obj, CoroutineContext coroutineContext) {
            m2277invoke5_sEAP8(th, ((ChannelResult) obj).getHolder(), coroutineContext);
            return Unit.INSTANCE;
        }

        /* JADX INFO: renamed from: invoke-5_sEAP8, reason: not valid java name */
        public final void m2277invoke5_sEAP8(Throwable th, Object obj, CoroutineContext coroutineContext) {
            ((BufferedChannel) this.receiver).m2271onCancellationChannelResultImplDoNotCall5_sEAP8(th, obj, coroutineContext);
        }
    }
    ...
    public final void m2271onCancellationChannelResultImplDoNotCall5_sEAP8(Throwable cause, Object element, CoroutineContext context) {
        Function1<E, Unit> function1 = this.onUndeliveredElement;
        Intrinsics.checkNotNull(function1);
        Object objM2287getOrNullimpl = ChannelResult.m2287getOrNullimpl(element);
        Intrinsics.checkNotNull(objM2287getOrNullimpl);
        OnUndeliveredElementKt.callUndeliveredElement(function1, objM2287getOrNullimpl, context);
    }
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            cancellableContinuationImpl3.resumeWith(Result.m773constructorimpl(ResultKt.createFailure(undeliveredElementExceptionRecoverFromStackFrame)));
        } else {
            ...
            cancellableContinuationImpl4.resumeWith(Result.m773constructorimpl(ResultKt.createFailure(sendException)));
        }
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x00b1, code lost:
        ...
        r1.resumeWith(kotlin.Result.m773constructorimpl(kotlin.coroutines.jvm.internal.Boxing.boxBoolean(true)));
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(BufferedChannel<E> bufferedChannel, E e, Continuation<? super Boolean> continuation) {
        ...
        Result.Companion companion = Result.INSTANCE;
        cancellableContinuationImpl2.resumeWith(Result.m773constructorimpl(Boxing.boxBoolean(false)));
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended(continuation);
        }
