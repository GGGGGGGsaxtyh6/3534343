    ...
    */
    public static final <E> Object toList(ReceiveChannel<? extends E> receiveChannel, Continuation<? super List<? extends E>> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            it = (ChannelIterator) c01201.L$3;
            ReceiveChannel<? extends E> receiveChannel3 = (ReceiveChannel) c01201.L$2;
            List list2 = (List) c01201.L$1;
            List list3 = (List) c01201.L$0;
            try {
                ResultKt.throwOnFailure(obj);
                ?? r52 = list2;
                List list4 = list3;
