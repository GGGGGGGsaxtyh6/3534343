...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM773constructorimpl = Result.m773constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM773constructorimpl = Result.m773constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m2282boximpl(Result.m780isSuccessimpl(objM773constructorimpl) ? ChannelResult.INSTANCE.m2297successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2295closedJP2dKIU(Result.m776exceptionOrNullimpl(objM773constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2268trySendJP2dKIU = sendChannel.mo2268trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m2292isSuccessimpl(sendChannel.mo2268trySendJP2dKIU(obj))) {
            return;
        }
