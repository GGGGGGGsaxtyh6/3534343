        ...
        */
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i4 == 0) {
                ...
                this.I$1 = b;
                this.label = 1;
                holder = channel.mo2274receiveCatchingJP2dKIU(this);
            ...
            if (i4 != 1) {
                ...
                if (holder != coroutine_suspended) {
                    ...
                    objArr2 = objArr;
                    bArr2 = bArr3;
                    indexedValue = (IndexedValue) ChannelResult.m2287getOrNullimpl(holder);
                    ...
                    while (true) {
                        ...
                        if (bArr2[index] != i3) {
                            bArr2[index] = (byte) i3;
                            indexedValue = (IndexedValue) ChannelResult.m2287getOrNullimpl(channel.mo2275tryReceivePtdJZtk());
                            if (indexedValue == null) {
                                if (i2 == 0) {
                                }
                            }
