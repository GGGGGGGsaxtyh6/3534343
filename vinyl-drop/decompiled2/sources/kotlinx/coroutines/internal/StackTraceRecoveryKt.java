...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM773constructorimpl2;
        ...
        try {
            ...
            objM773constructorimpl = Result.m773constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM773constructorimpl = Result.m773constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m776exceptionOrNullimpl(objM773constructorimpl) == null) {
            obj2 = objM773constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM773constructorimpl2 = Result.m773constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM773constructorimpl2 = Result.m773constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m776exceptionOrNullimpl(objM773constructorimpl2) == null) {
            obj = objM773constructorimpl2;
        }
