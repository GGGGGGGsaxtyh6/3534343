...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m2319boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <E> Object m2320constructorimpl(Object obj) {
        return obj;
    }
    ...
    public static int m2325hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public static String m2327toStringimpl(Object obj) {
        return "InlineList(holder=" + obj + ')';
    }

    public boolean equals(Object other) {
        return m2322equalsimpl(this.holder, other);
    }

    public int hashCode() {
        return m2325hashCodeimpl(this.holder);
    }

    public String toString() {
        return m2327toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m2321constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m2320constructorimpl(obj);
    }

    /* JADX INFO: renamed from: plus-FjFbRPM, reason: not valid java name */
    public static final Object m2326plusFjFbRPM(Object obj, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && (e instanceof List)) {
            throw new AssertionError();
        }
        if (obj == null) {
            return m2320constructorimpl(e);
        }
        ...
        arrayList.add(obj);
        arrayList.add(e);
        return m2320constructorimpl(arrayList);
    }

    /* JADX INFO: renamed from: forEachReversed-impl, reason: not valid java name */
    public static final void m2324forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
        if (!(obj instanceof ArrayList)) {
