    ...
    */
    public static final <T> void resumeCancellableWith(Continuation<? super T> continuation, Object obj) {
        ...
        if (dispatchedContinuation.dispatcher.isDispatchNeeded(dispatchedContinuation.getContext())) {
            ...
            dispatchedContinuation.dispatcher.mo2330dispatch(dispatchedContinuation.getContext(), dispatchedContinuation);
            return;
        }
        ...
        if (job != null && !job.isActive()) {
            ...
            dispatchedContinuation.resumeWith(Result.m773constructorimpl(ResultKt.createFailure(cancellationException)));
        } else {
