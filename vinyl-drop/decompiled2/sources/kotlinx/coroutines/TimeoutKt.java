...
public final class TimeoutKt {
    ...
    public static final <T> Object m2266withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m2258toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    */
    ...
    public static final <T> Object m2267withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m2258toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    */
    public static final TimeoutCancellationException TimeoutCancellationException(long j, Delay delay, Job job) {
        String strM2259timeoutMessageLRDsOJo;
        ...
        if (delayWithTimeoutDiagnostics != null) {
            ...
            strM2259timeoutMessageLRDsOJo = delayWithTimeoutDiagnostics.m2259timeoutMessageLRDsOJo(DurationKt.toDuration(j, DurationUnit.MILLISECONDS));
            if (strM2259timeoutMessageLRDsOJo == null) {
                strM2259timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
            }
        }
        return new TimeoutCancellationException(strM2259timeoutMessageLRDsOJo, job);
    }
}
