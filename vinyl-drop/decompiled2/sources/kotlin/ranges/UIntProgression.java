...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = UProgressionUtilKt.m1991getProgressionLastElementNkh28Cs(i, i2, i3);
        this.step = i3;
    }
    ...
    public boolean isEmpty() {
        int i = this.step;
        int i2 = this.first;
        return i > 0 ? Integer.compare(i2 ^ Integer.MIN_VALUE, this.last ^ Integer.MIN_VALUE) > 0 : Integer.compare(i2 ^ Integer.MIN_VALUE, this.last ^ Integer.MIN_VALUE) < 0;
    }
    ...
    public String toString() {
        ...
        int i3 = this.first;
        if (i2 > 0) {
            sbAppend = new StringBuilder().append((Object) UInt.m919toStringimpl(i3)).append("..").append((Object) UInt.m919toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) UInt.m919toStringimpl(i3)).append(" downTo ").append((Object) UInt.m919toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m2008fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
