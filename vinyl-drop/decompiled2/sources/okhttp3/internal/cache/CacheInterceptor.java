...
public final class CacheInterceptor implements Interceptor {
    ...
    private final Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(Response.header$default(response, com.google.common.net.HttpHeaders.CONTENT_TYPE, null, 2, null), response.body().getContentLength(), Okio.buffer(source2))).build();
    }
