...
final class PDF417HighLevelEncoder {
        ...
        if (i == 1) {
            ...
            if (i != 3) {
                ...
                while (i2 < length) {
                    ...
                    int iDetermineConsecutiveDigitCount = determineConsecutiveDigitCount(noECIInput, i2);
                    if (iDetermineConsecutiveDigitCount >= 13) {
                        sb.append((char) 902);
                        encodeNumeric(noECIInput, i2, iDetermineConsecutiveDigitCount, sb);
                        i2 += iDetermineConsecutiveDigitCount;
                        iEncodeText = 0;
                        i3 = 2;
                    } else {
                        int iDetermineConsecutiveTextCount = determineConsecutiveTextCount(noECIInput, i2);
                        if (iDetermineConsecutiveTextCount >= 5 || iDetermineConsecutiveDigitCount == length) {
                            ...
                            iEncodeText = encodeText(noECIInput, i2, iDetermineConsecutiveTextCount, sb, iEncodeText);
                            i2 += iDetermineConsecutiveTextCount;
                        } else {
                            int iDetermineConsecutiveBinaryCount = determineConsecutiveBinaryCount(noECIInput, i2, z ? null : charset);
                            if (iDetermineConsecutiveBinaryCount == 0) {
                                iDetermineConsecutiveBinaryCount = 1;
                            }
                            byte[] bytes = z ? null : noECIInput.subSequence(i2, i2 + iDetermineConsecutiveBinaryCount).toString().getBytes(charset);
                            if ((!(bytes == null && iDetermineConsecutiveBinaryCount == 1) && (bytes == null || bytes.length != 1)) || i3 != 0) {
                                if (z) {
                                    encodeMultiECIBinary(noECIInput, i2, i2 + iDetermineConsecutiveBinaryCount, i3, sb);
                                } else {
    ...
    protected static void checkCharset(String str, int i, String str2) throws WriterException {
        for (int i2 = 0; i2 < str.length(); i2++) {
            if (str.charAt(i2) > i) {
                throw new WriterException("Non-encodable character detected: " + str.charAt(i2) + " (Unicode: " + ((int) str.charAt(i2)) + ") at position #" + i2 + " - " + str2);
            }
        }
    }
    ...
    */
    ...
    private static void encodeNumeric(ECIInput eCIInput, int i, int i2, StringBuilder sb) {
        ...
        while (i3 < i2) {
            ...
            int i4 = i + i3;
            BigInteger bigInteger = new BigInteger("1" + ((Object) eCIInput.subSequence(i4, i4 + iMin)));
            do {
