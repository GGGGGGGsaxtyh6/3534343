...
public final class Target extends GeneratedMessageLite<Target, Builder> implements TargetOrBuilder {
    ...
    /* JADX INFO: renamed from: com.google.firestore.v1.Target$1, reason: invalid class name */
    ...
    public static final class PipelineQueryTarget extends GeneratedMessageLite<PipelineQueryTarget, Builder> implements PipelineQueryTargetOrBuilder {
        ...
        public static PipelineQueryTarget parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            return (PipelineQueryTarget) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, extensionRegistryLite);
        }

        public static PipelineQueryTarget parseFrom(ByteString byteString) throws InvalidProtocolBufferException {
            return (PipelineQueryTarget) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString);
        }

        public static PipelineQueryTarget parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            return (PipelineQueryTarget) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, extensionRegistryLite);
        }
        ...
        public static PipelineQueryTarget parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            return (PipelineQueryTarget) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, extensionRegistryLite);
        }
        ...
        public static PipelineQueryTarget parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            return (PipelineQueryTarget) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
        }

        public static PipelineQueryTarget parseDelimitedFrom(InputStream inputStream) throws IOException {
            return (PipelineQueryTarget) parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
        }

        public static PipelineQueryTarget parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            return (PipelineQueryTarget) parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
        }
        ...
        public static PipelineQueryTarget parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            return (PipelineQueryTarget) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, codedInputStream, extensionRegistryLite);
        }
        ...
        public static Builder newBuilder(PipelineQueryTarget pipelineQueryTarget) {
            return DEFAULT_INSTANCE.createBuilder(pipelineQueryTarget);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<PipelineQueryTarget, Builder> implements PipelineQueryTargetOrBuilder {
            ...
            public Builder setStructuredPipeline(StructuredPipeline structuredPipeline) {
                copyOnWrite();
                ((PipelineQueryTarget) this.instance).setStructuredPipeline(structuredPipeline);
                return this;
            }

            public Builder setStructuredPipeline(StructuredPipeline.Builder builder) {
                copyOnWrite();
                ((PipelineQueryTarget) this.instance).setStructuredPipeline(builder.build());
                return this;
            }

            public Builder mergeStructuredPipeline(StructuredPipeline structuredPipeline) {
                copyOnWrite();
                ((PipelineQueryTarget) this.instance).mergeStructuredPipeline(structuredPipeline);
                return this;
            }
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
                ...
                case 2:
                    return new Builder(anonymousClass1);
                case 3:
                    return newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0001\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001<\u0000", new Object[]{"pipelineType_", "pipelineTypeCase_", StructuredPipeline.class});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
    ...
    public void mergeQuery(QueryTarget queryTarget) {
        ...
        if (this.targetTypeCase_ == 2 && this.targetType_ != QueryTarget.getDefaultInstance()) {
            this.targetType_ = QueryTarget.newBuilder((QueryTarget) this.targetType_).mergeFrom(queryTarget).buildPartial();
        } else {
            this.targetType_ = queryTarget;
        }
        this.targetTypeCase_ = 2;
    ...
    public void mergeDocuments(DocumentsTarget documentsTarget) {
        ...
        if (this.targetTypeCase_ == 3 && this.targetType_ != DocumentsTarget.getDefaultInstance()) {
            this.targetType_ = DocumentsTarget.newBuilder((DocumentsTarget) this.targetType_).mergeFrom(documentsTarget).buildPartial();
        } else {
            this.targetType_ = documentsTarget;
        }
        this.targetTypeCase_ = 3;
    ...
    public void mergePipelineQuery(PipelineQueryTarget pipelineQueryTarget) {
        ...
        if (this.targetTypeCase_ == 13 && this.targetType_ != PipelineQueryTarget.getDefaultInstance()) {
            this.targetType_ = PipelineQueryTarget.newBuilder((PipelineQueryTarget) this.targetType_).mergeFrom(pipelineQueryTarget).buildPartial();
        } else {
            this.targetType_ = pipelineQueryTarget;
        }
        this.targetTypeCase_ = 13;
    ...
    public void mergeExpectedCount(Int32Value int32Value) {
        ...
        if (int32Value2 != null && int32Value2 != Int32Value.getDefaultInstance()) {
            this.expectedCount_ = Int32Value.newBuilder(this.expectedCount_).mergeFrom(int32Value).buildPartial();
        } else {
            this.expectedCount_ = int32Value;
        }
        this.bitField0_ |= 1;
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Target, Builder> implements TargetOrBuilder {
        ...
        public Builder setPipelineQuery(PipelineQueryTarget pipelineQueryTarget) {
            copyOnWrite();
            ((Target) this.instance).setPipelineQuery(pipelineQueryTarget);
            return this;
        }

        public Builder setPipelineQuery(PipelineQueryTarget.Builder builder) {
            copyOnWrite();
            ((Target) this.instance).setPipelineQuery(builder.build());
            return this;
        }

        public Builder mergePipelineQuery(PipelineQueryTarget pipelineQueryTarget) {
            copyOnWrite();
            ((Target) this.instance).mergePipelineQuery(pipelineQueryTarget);
            return this;
        }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
            ...
            case 2:
                return new Builder(anonymousClass1);
            case 3:
                return newMessageInfo(DEFAULT_INSTANCE, "\u0000\b\u0002\u0001\u0002\r\b\u0000\u0000\u0000\u0002<\u0000\u0003<\u0000\u0004=\u0001\u0005\u0004\u0006\u0007\u000b<\u0001\fဉ\u0000\r<\u0000", new Object[]{"targetType_", "targetTypeCase_", "resumeType_", "resumeTypeCase_", "bitField0_", QueryTarget.class, DocumentsTarget.class, "targetId_", "once_", Timestamp.class, "expectedCount_", PipelineQueryTarget.class});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
