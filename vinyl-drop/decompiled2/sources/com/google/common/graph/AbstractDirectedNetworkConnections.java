    ...
    public Set<E> incidentEdges() {
        return new AbstractSet<E>() { // from class: com.google.common.graph.AbstractDirectedNetworkConnections.1
            ...
            public UnmodifiableIterator<E> iterator() {
                ...
                if (i == 0) {
                    iterableUnion = Iterables.concat(abstractDirectedNetworkConnections.inEdgeMap.keySet(), AbstractDirectedNetworkConnections.this.outEdgeMap.keySet());
                } else {
                    iterableUnion = Sets.union(abstractDirectedNetworkConnections.inEdgeMap.keySet(), AbstractDirectedNetworkConnections.this.outEdgeMap.keySet());
                }
