...
public final class zzaen {
    ...
    */
        ...
        if (statusCode != 17021) {
            if (statusCode != 17051) {
                ...
                switch (statusCode) {
                    ...
                    case 17200:
                        return new zzad(zza(statusCode), strZza);
    ...
    public static FirebaseAuthMultiFactorException zza(FirebaseAuth firebaseAuth, zzaas zzaasVar, FirebaseUser firebaseUser) {
        zzu.zza(firebaseAuth);
        zzu.zza(zzaasVar);
        Pair<String, String> pair = zza.get(17078);
        return new FirebaseAuthMultiFactorException((String) pair.first, (String) pair.second, zzal.zza(zzaasVar, firebaseAuth, firebaseUser));
    }
    ...
    private static String zza(String str, Status status) {
        return TextUtils.isEmpty(status.getStatusMessage()) ? str : String.format(str + " [ %s ]", status.getStatusMessage());
    }
