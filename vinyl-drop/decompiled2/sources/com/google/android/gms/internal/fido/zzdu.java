...
public final class zzdu implements Closeable {
    ...
    private final long zzh() throws IOException {
        ...
        if (this.zzb.zza() == 26) {
            ...
            byte[] bArr2 = this.zzc;
            long j = bArr2[0];
            return ((bArr2[1] & 255) << 16) | ((j & 255) << 24) | ((bArr2[2] & 255) << 8) | (bArr2[3] & 255);
        }
        if (this.zzb.zza() != 27) {
        ...
        long j4 = bArr3[2];
        long j5 = bArr3[3];
        return (((long) bArr3[7]) & 255) | ((j5 & 255) << 32) | ((j4 & 255) << 40) | ((j2 & 255) << 56) | ((j3 & 255) << 48) | ((bArr3[4] & 255) << 24) | ((bArr3[5] & 255) << 16) | ((bArr3[6] & 255) << 8);
    }
