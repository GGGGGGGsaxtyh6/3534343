...
public final class CloudMessage extends AbstractSafeParcelable {
    ...
    public final long getSentTime() {
        ...
        try {
            ...
            Log.w("CloudMessage", new StringBuilder(String.valueOf(strValueOf).length() + 19).append("Invalid sent time: ").append(strValueOf).toString());
            return 0L;
        }
    }
    ...
    public final int getTtl() {
        ...
        try {
            ...
            String strValueOf = String.valueOf(obj);
            Log.w("CloudMessage", new StringBuilder(String.valueOf(strValueOf).length() + 13).append("Invalid TTL: ").append(strValueOf).toString());
            return 0;
        }
    }
