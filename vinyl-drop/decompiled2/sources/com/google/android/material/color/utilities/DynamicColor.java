...
public final class DynamicColor {
    ...
    public double getTone(DynamicScheme dynamicScheme) {
        ...
        if (function != null) {
            ...
            double d2 = dynamicColor.contrastCurve.get(dynamicScheme.contrastLevel);
            double d3 = 60.0d;
            ...
            if (Contrast.ratioOfTones(tone, dDoubleValue) < d2) {
                dDoubleValue = foregroundTone(tone, d2);
            }
            ...
            if ((dDoubleValue2 - dDoubleValue) * d < delta) {
                double d5 = delta * d;
                dDoubleValue2 = MathUtils.clampDouble(AudioStats.AUDIO_AMPLITUDE_NONE, 100.0d, dDoubleValue + d5);
                if ((dDoubleValue2 - dDoubleValue) * d < delta) {
                    dDoubleValue = MathUtils.clampDouble(AudioStats.AUDIO_AMPLITUDE_NONE, 100.0d, dDoubleValue2 - d5);
                }
            }
        ...
        double d7 = (!this.isBackground || 50.0d > dDoubleValue3 || dDoubleValue3 >= 60.0d) ? dDoubleValue3 : Contrast.ratioOfTones(49.0d, tone2) >= d6 ? 49.0d : 60.0d;
        if (this.secondBackground != null) {
            ...
            if (Contrast.ratioOfTones(dMax2, d7) < d6 || Contrast.ratioOfTones(dMin2, d7) < d6) {
