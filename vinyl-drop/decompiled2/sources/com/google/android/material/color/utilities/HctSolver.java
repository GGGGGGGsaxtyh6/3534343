...
public class HctSolver {
    ...
    static double inverseChromaticAdaptation(double d) {
        ...
        return ((double) MathUtils.signum(d)) * Math.pow(Math.max(AudioStats.AUDIO_AMPLITUDE_NONE, (27.13d * dAbs) / (400.0d - dAbs)), 2.380952380952381d);
    }
    ...
    static int findResultByJ(double d, double d2, double d3) {
        ...
        while (i < 5) {
            ...
            double d8 = d5;
            double d9 = dSqrt;
            double dPow2 = Math.pow(((d2 == AudioStats.AUDIO_AMPLITUDE_NONE || dSqrt == AudioStats.AUDIO_AMPLITUDE_NONE) ? 0.0d : d2 / Math.sqrt(d7)) * dPow, 1.1111111111111112d);
