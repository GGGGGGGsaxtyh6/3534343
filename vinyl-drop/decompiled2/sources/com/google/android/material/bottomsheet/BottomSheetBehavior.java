        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.5
            ...
            */
            public void onViewReleased(View view, float f, float f2) {
                ...
                if (f2 < 0.0f) {
                    if (bottomSheetBehavior.fitToContents) {
                        ...
                        if (zShouldSkipHalfExpandedStateWhenDragging) {
                            if (!BottomSheetBehavior.this.shouldExpandOnUpwardDrag(jUptimeMillis, (top * 100.0f) / bottomSheetBehavior2.parentHeight)) {
                                i = 4;
                            }
                ...
                } else if (bottomSheetBehavior.hideable && BottomSheetBehavior.this.shouldHide(view, f2)) {
                    ...
                    if (z) {
                        if (Math.abs(top3 - bottomSheetBehavior3.fitToContentsOffset) < Math.abs(top3 - BottomSheetBehavior.this.collapsedOffset)) {
                        }
                    } else {
                        ...
                        } else if (Math.abs(top3 - bottomSheetBehavior4.halfExpandedOffset) >= Math.abs(top3 - BottomSheetBehavior.this.collapsedOffset) || BottomSheetBehavior.this.shouldSkipHalfExpandedStateWhenDragging()) {
                        }
                    }
                }
                BottomSheetBehavior bottomSheetBehavior5 = BottomSheetBehavior.this;
                bottomSheetBehavior5.startSettling(view, i, bottomSheetBehavior5.shouldSkipSmoothAnimation());
            }
