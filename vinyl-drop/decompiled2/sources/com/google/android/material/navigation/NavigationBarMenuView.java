    ...
    public void buildMenuView() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (z) {
                ...
                objCreateMenuItem = navigationBarDividerView;
                ...
                objCreateMenuItem = navigationBarSubheaderView;
            } else if (size2 > 0) {
                size2--;
                objCreateMenuItem = createMenuItem(i2, (MenuItemImpl) itemAt, zIsShifting, true);
            } else {
                MenuItemImpl menuItemImpl = (MenuItemImpl) itemAt;
                boolean z2 = i >= this.collapsedMaxItemCount;
                i++;
                objCreateMenuItem = createMenuItem(i2, menuItemImpl, zIsShifting, z2);
            }
            if (!z && itemAt.isCheckable() && this.selectedItemPosition == -1) {
                this.selectedItemPosition = i2;
            }
            this.buttons[i2] = objCreateMenuItem;
            addView((View) objCreateMenuItem);
        }
