    ...
    public final boolean zza(byte[] bArr) {
        ...
        try {
            ...
            if (URLUtil.isHttpUrl(this.zza)) {
                ...
                httpsURLConnection = (HttpURLConnection) uRLConnectionOpenConnection;
            } else {
            ...
            httpsURLConnection.setRequestProperty(HttpHeaders.CONTENT_TYPE, "application/x-protobuffer");
