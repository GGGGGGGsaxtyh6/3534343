            ...
            return new Function1<MutableDocument, EvaluateResult>() { // from class: com.google.firebase.firestore.pipeline.evaluation.TimestampKt$special$$inlined$ternaryTimestampFunction$1.1
                ...
                */
                public final EvaluateResult invoke(final MutableDocument input) {
                    ...
                    try {
                        Function0<EvaluateResult> function0 = new Function0<EvaluateResult>() { // from class: com.google.firebase.firestore.pipeline.evaluation.TimestampKt$special$.inlined.ternaryTimestampFunction.1.1.1
                        ...
                        Function0<EvaluateResult> function02 = new Function0<EvaluateResult>() { // from class: com.google.firebase.firestore.pipeline.evaluation.TimestampKt$special$.inlined.ternaryTimestampFunction.1.1.2
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // kotlin.jvm.functions.Function0
                            public final EvaluateResult invoke() {
                        ...
                        Function0<EvaluateResult> function03 = new Function0<EvaluateResult>() { // from class: com.google.firebase.firestore.pipeline.evaluation.TimestampKt$special$.inlined.ternaryTimestampFunction.1.1.3
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // kotlin.jvm.functions.Function0
                            public final EvaluateResult invoke() {
                        ...
                        if (timestampValue != null && lValueOf != null) {
                            ...
                            if (Build.VERSION.SDK_INT >= 26) {
                                Instant instantPlus = Instant.ofEpochSecond(timestampValue.getSeconds(), timestampValue.getNanos()).plus(jLongValue, (TemporalUnit) TimestampKt.convertUnit(stringValue));
                                return !TimestampKt.isTimestampInBounds(instantPlus.getEpochSecond(), instantPlus.getNano()) ? EvaluateResultError.INSTANCE : EvaluateResult.INSTANCE.timestamp(instantPlus.getEpochSecond(), instantPlus.getNano());
                            }
                            switch (stringValue.hashCode()) {
                                case -1074026988:
                                    if (stringValue.equals("minute")) {
                                        timestampPlus = TimestampKt.plus(timestampValue, LongMath.checkedMultiply(jLongValue, 60L));
                                        if (!TimestampKt.isTimestampInBounds(timestampPlus.getSeconds(), timestampPlus.getNanos())) {
                                        }
                                    }
                                    break;
                                case -906279820:
                                    if (!stringValue.equals("second")) {
                                        break;
                                    } else {
                                        timestampPlus = TimestampKt.plus(timestampValue, jLongValue);
                                        if (!TimestampKt.isTimestampInBounds(timestampPlus.getSeconds(), timestampPlus.getNanos())) {
                                        }
                                    }
                                    break;
                                case -368353224:
                                    if (!stringValue.equals("microsecond")) {
                                        break;
                                    } else {
                                        timestampPlus = TimestampKt.plus(timestampValue, jLongValue / 1000000, (jLongValue % 1000000) * ((long) 1000));
                                        if (!TimestampKt.isTimestampInBounds(timestampPlus.getSeconds(), timestampPlus.getNanos())) {
                                        }
                                    }
                                    break;
                                case 99228:
                                    if (!stringValue.equals("day")) {
                                        ...
                                        timestampPlus = TimestampKt.plus(timestampValue, LongMath.checkedMultiply(jLongValue, 86400L));
                                        if (!TimestampKt.isTimestampInBounds(timestampPlus.getSeconds(), timestampPlus.getNanos())) {
                                        }
                                    }
                                    break;
                                case 3208676:
                                    if (!stringValue.equals("hour")) {
                                        ...
                                        timestampPlus = TimestampKt.plus(timestampValue, LongMath.checkedMultiply(jLongValue, 3600L));
                                        if (!TimestampKt.isTimestampInBounds(timestampPlus.getSeconds(), timestampPlus.getNanos())) {
                                        }
                                    }
                                    break;
                                case 1942410881:
                                    if (!stringValue.equals("millisecond")) {
                                        break;
                                    } else {
                                        timestampPlus = TimestampKt.plus(timestampValue, jLongValue / 1000, (jLongValue % 1000) * ((long) DurationKt.NANOS_IN_MILLIS));
                                        if (!TimestampKt.isTimestampInBounds(timestampPlus.getSeconds(), timestampPlus.getNanos())) {
                                        }
                                    }
                                    break;
        ...
        public final Function1<MutableDocument, EvaluateResult> invoke(List<? extends Function1<? super MutableDocument, ? extends EvaluateResult>> params) {
            ...
            return new Function1<MutableDocument, EvaluateResult>() { // from class: com.google.firebase.firestore.pipeline.evaluation.TimestampKt$special$$inlined$ternaryTimestampFunction$2.1
                ...
                */
                public final EvaluateResult invoke(final MutableDocument input) {
                    Timestamp timestampValue;
                    Timestamp timestampMinus;
                    Intrinsics.checkNotNullParameter(input, "input");
                    final Function1 function14 = function1;
                    final Function1 function15 = function12;
                    final Function1 function16 = function13;
                    try {
                        Function0<EvaluateResult> function0 = new Function0<EvaluateResult>() { // from class: com.google.firebase.firestore.pipeline.evaluation.TimestampKt$special$.inlined.ternaryTimestampFunction.2.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // kotlin.jvm.functions.Function0
                            public final EvaluateResult invoke() {
                                return (EvaluateResult) function14.invoke(input);
                        ...
                        Function0<EvaluateResult> function02 = new Function0<EvaluateResult>() { // from class: com.google.firebase.firestore.pipeline.evaluation.TimestampKt$special$.inlined.ternaryTimestampFunction.2.1.2
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // kotlin.jvm.functions.Function0
                            public final EvaluateResult invoke() {
                                return (EvaluateResult) function15.invoke(input);
                        ...
                        Function0<EvaluateResult> function03 = new Function0<EvaluateResult>() { // from class: com.google.firebase.firestore.pipeline.evaluation.TimestampKt$special$.inlined.ternaryTimestampFunction.2.1.3
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // kotlin.jvm.functions.Function0
                            public final EvaluateResult invoke() {
                                return (EvaluateResult) function16.invoke(input);
                        ...
                        if (timestampValue != null && lValueOf != null) {
                            long jLongValue = lValueOf.longValue();
                            if (Build.VERSION.SDK_INT >= 26) {
                                Instant instantMinus = Instant.ofEpochSecond(timestampValue.getSeconds(), timestampValue.getNanos()).minus(jLongValue, (TemporalUnit) TimestampKt.convertUnit(stringValue));
                                return !TimestampKt.isTimestampInBounds(instantMinus.getEpochSecond(), instantMinus.getNano()) ? EvaluateResultError.INSTANCE : EvaluateResult.INSTANCE.timestamp(instantMinus.getEpochSecond(), instantMinus.getNano());
                            }
                            switch (stringValue.hashCode()) {
                                case -1074026988:
                                    if (stringValue.equals("minute")) {
                                        timestampMinus = TimestampKt.minus(timestampValue, LongMath.checkedMultiply(jLongValue, 60L));
                                        if (!TimestampKt.isTimestampInBounds(timestampMinus.getSeconds(), timestampMinus.getNanos())) {
                                        }
                                    }
                                    break;
                                case -906279820:
                                    if (!stringValue.equals("second")) {
                                        ...
                                        timestampMinus = TimestampKt.minus(timestampValue, jLongValue);
                                        if (!TimestampKt.isTimestampInBounds(timestampMinus.getSeconds(), timestampMinus.getNanos())) {
                                        }
                                    }
                                    break;
                                case -368353224:
                                    if (!stringValue.equals("microsecond")) {
                                        ...
                                        timestampMinus = TimestampKt.minus(timestampValue, jLongValue / 1000000, (jLongValue % 1000000) * ((long) 1000));
                                        if (!TimestampKt.isTimestampInBounds(timestampMinus.getSeconds(), timestampMinus.getNanos())) {
                                        }
                                    }
                                    break;
                                case 99228:
                                    if (!stringValue.equals("day")) {
                                        ...
                                        timestampMinus = TimestampKt.minus(timestampValue, LongMath.checkedMultiply(jLongValue, 86400L));
                                        if (!TimestampKt.isTimestampInBounds(timestampMinus.getSeconds(), timestampMinus.getNanos())) {
                                        }
                                    }
                                    break;
                                case 3208676:
                                    if (!stringValue.equals("hour")) {
                                        ...
                                        timestampMinus = TimestampKt.minus(timestampValue, LongMath.checkedMultiply(jLongValue, 3600L));
                                        if (!TimestampKt.isTimestampInBounds(timestampMinus.getSeconds(), timestampMinus.getNanos())) {
                                        }
                                    }
                                    break;
                                case 1942410881:
                                    if (!stringValue.equals("millisecond")) {
                                        ...
                                        timestampMinus = TimestampKt.minus(timestampValue, jLongValue / 1000, (jLongValue % 1000) * ((long) DurationKt.NANOS_IN_MILLIS));
                                        if (!TimestampKt.isTimestampInBounds(timestampMinus.getSeconds(), timestampMinus.getNanos())) {
                                        }
                                    }
                                    break;
