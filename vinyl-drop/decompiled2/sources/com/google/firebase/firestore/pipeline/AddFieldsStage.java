...
public final class AddFieldsStage extends Stage<AddFieldsStage> {
    ...
    public AddFieldsStage(Selectable[] fields, InternalOptions options) {
        ...
        for (Selectable selectable : fields) {
            String alias = selectable.getAlias();
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof AddFieldsStage)) {
            return false;
        }
        AddFieldsStage addFieldsStage = (AddFieldsStage) other;
        return Arrays.equals(this.fields, addFieldsStage.fields) && Intrinsics.areEqual(getOptions(), addFieldsStage.getOptions());
    }
