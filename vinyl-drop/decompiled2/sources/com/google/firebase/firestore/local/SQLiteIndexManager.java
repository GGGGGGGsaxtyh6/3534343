...
final class SQLiteIndexManager implements IndexManager {
    ...
    public void start() {
        ...
        this.db.query("SELECT index_id, collection_group, index_proto FROM index_configuration").forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteIndexManager$$ExternalSyntheticLambda7
            @Override // com.google.firebase.firestore.util.Consumer
            public final void accept(Object obj) {
                this.f$0.m680x30c0807a(map, (Cursor) obj);
            }
        });
        this.started = true;
    }
    ...
    /* synthetic */ void m680x30c0807a(Map map, Cursor cursor) {
        try {
    ...
    public void m681x55deb5b3(Document document, IndexEntry indexEntry) {
    ...
    public void m682x57150892(Document document, IndexEntry indexEntry) {
    ...
    public List<DocumentKey> getDocumentsMatchingTarget(Target target) {
        ...
        queryBinding.forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteIndexManager$$ExternalSyntheticLambda4
            @Override // com.google.firebase.firestore.util.Consumer
            public final void accept(Object obj) {
    ...
    private Object[] generateQueryAndBindings(Target target, int i, List<Value> list, Object[] objArr, String str, Object[] objArr2, String str2, Object[] objArr3) {
        ...
        StringBuilder sbRepeatSequence = Util.repeatSequence(sb, size, " UNION ");
        if (objArr3 != null) {
        ...
        Object[] objArrFillBounds = fillBounds(size, i, list, objArr, objArr2, objArr3);
        ArrayList arrayList = new ArrayList();
    ...
    private Object[] fillBounds(int i, int i2, List<Value> list, Object[] objArr, Object[] objArr2, Object[] objArr3) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            ...
            int i7 = i4 + 3;
            if (list != null) {
                bArrEncodeSingleElement = encodeSingleElement(list.get(i5 / size));
            } else {
                bArrEncodeSingleElement = EMPTY_BYTES_VALUE;
            }
            objArr4[i6] = bArrEncodeSingleElement;
            int i8 = i4 + 4;
            int i9 = i5 % size;
