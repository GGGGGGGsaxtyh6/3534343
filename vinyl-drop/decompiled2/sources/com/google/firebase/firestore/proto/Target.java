...
public final class Target extends GeneratedMessageLite<Target, Builder> implements TargetOrBuilder {
    ...
    public void mergeSnapshotVersion(Timestamp timestamp) {
        ...
        if (timestamp2 != null && timestamp2 != Timestamp.getDefaultInstance()) {
            this.snapshotVersion_ = Timestamp.newBuilder(this.snapshotVersion_).mergeFrom(timestamp).buildPartial();
        } else {
            this.snapshotVersion_ = timestamp;
        }
        this.bitField0_ |= 1;
    ...
    public void mergeQuery(Target.QueryTarget queryTarget) {
        ...
        if (this.targetTypeCase_ == 5 && this.targetType_ != Target.QueryTarget.getDefaultInstance()) {
            this.targetType_ = Target.QueryTarget.newBuilder((Target.QueryTarget) this.targetType_).mergeFrom(queryTarget).buildPartial();
        } else {
            this.targetType_ = queryTarget;
        }
        this.targetTypeCase_ = 5;
    ...
    public void mergeDocuments(Target.DocumentsTarget documentsTarget) {
        ...
        if (this.targetTypeCase_ == 6 && this.targetType_ != Target.DocumentsTarget.getDefaultInstance()) {
            this.targetType_ = Target.DocumentsTarget.newBuilder((Target.DocumentsTarget) this.targetType_).mergeFrom(documentsTarget).buildPartial();
        } else {
            this.targetType_ = documentsTarget;
        }
        this.targetTypeCase_ = 6;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setPipelineQuery(Target.PipelineQueryTarget pipelineQueryTarget) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void mergePipelineQuery(Target.PipelineQueryTarget pipelineQueryTarget) {
        pipelineQueryTarget.getClass();
        if (this.targetTypeCase_ == 13 && this.targetType_ != Target.PipelineQueryTarget.getDefaultInstance()) {
            this.targetType_ = Target.PipelineQueryTarget.newBuilder((Target.PipelineQueryTarget) this.targetType_).mergeFrom(pipelineQueryTarget).buildPartial();
        } else {
            this.targetType_ = pipelineQueryTarget;
        }
        this.targetTypeCase_ = 13;
    ...
    public void mergeLastLimboFreeSnapshotVersion(Timestamp timestamp) {
        ...
        if (timestamp2 != null && timestamp2 != Timestamp.getDefaultInstance()) {
            this.lastLimboFreeSnapshotVersion_ = Timestamp.newBuilder(this.lastLimboFreeSnapshotVersion_).mergeFrom(timestamp).buildPartial();
        } else {
            this.lastLimboFreeSnapshotVersion_ = timestamp;
        }
        this.bitField0_ |= 2;
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Target, Builder> implements TargetOrBuilder {
        ...
        public Builder setPipelineQuery(Target.PipelineQueryTarget pipelineQueryTarget) {
            copyOnWrite();
            ((Target) this.instance).setPipelineQuery(pipelineQueryTarget);
            return this;
        }

        public Builder setPipelineQuery(Target.PipelineQueryTarget.Builder builder) {
            copyOnWrite();
            ((Target) this.instance).setPipelineQuery(builder.build());
            return this;
        }

        public Builder mergePipelineQuery(Target.PipelineQueryTarget pipelineQueryTarget) {
            copyOnWrite();
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
            ...
            case 3:
                return newMessageInfo(DEFAULT_INSTANCE, "\u0000\b\u0001\u0001\u0001\r\b\u0000\u0000\u0000\u0001\u0004\u0002ဉ\u0000\u0003\n\u0004\u0002\u0005<\u0000\u0006<\u0000\u0007ဉ\u0001\r<\u0000", new Object[]{"targetType_", "targetTypeCase_", "bitField0_", "targetId_", "snapshotVersion_", "resumeToken_", "lastListenSequenceNumber_", Target.QueryTarget.class, Target.DocumentsTarget.class, "lastLimboFreeSnapshotVersion_", Target.PipelineQueryTarget.class});
            case 4:
