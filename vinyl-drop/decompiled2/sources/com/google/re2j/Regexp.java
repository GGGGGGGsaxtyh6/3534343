...
class Regexp {
    ...
    */
    public boolean equals(Object obj) {
        ...
        int i = AnonymousClass1.$SwitchMap$com$google$re2j$Regexp$Op[this.op.ordinal()];
        if (i == 1 || i == 2 || i == 3) {
            ...
            if (i == 7 || i == 8) {
                ...
                if (!Arrays.equals(this.runes, regexp.runes)) {
                    return false;
                }
            } else if (i != 12) {
                if (i != 14) {
                ...
                } else if ((this.flags & 256) != (regexp.flags & 256)) {
                    return false;
                }
            } else if (this.cap != regexp.cap || ((str = this.name) != null ? !str.equals(regexp.name) : regexp.name != null) || !this.subs[0].equals(regexp.subs[0])) {
                return false;
            }
