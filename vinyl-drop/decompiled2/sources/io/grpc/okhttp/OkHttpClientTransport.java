        ...
        public void windowUpdate(int i, long j) {
            ...
            if (j != 0) {
                synchronized (OkHttpClientTransport.this.lock) {
                    OkHttpClientTransport okHttpClientTransport = OkHttpClientTransport.this;
                    if (i == 0) {
                        okHttpClientTransport.outboundFlow.windowUpdate(null, (int) j);
                        return;
                    }
                    OkHttpClientStream okHttpClientStream = (OkHttpClientStream) okHttpClientTransport.streams.get(Integer.valueOf(i));
                    OkHttpClientTransport okHttpClientTransport2 = OkHttpClientTransport.this;
                    if (okHttpClientStream != null) {
                        okHttpClientTransport2.outboundFlow.windowUpdate(okHttpClientStream.transportState().getOutboundFlowState(), (int) j);
                    } else {
                        z = okHttpClientTransport2.mayHaveCreatedStream(i) ? false : true;
                        if (z) {
                            return;
                        }
                ...
                if (i == 0) {
                    ...
                    okHttpClientTransport3.finishStream(i, Status.INTERNAL.withDescription("Received 0 flow control window increment."), ClientStreamListener.RpcProgress.PROCESSED, false, ErrorCode.PROTOCOL_ERROR, null);
                }
            }
        }
    }
