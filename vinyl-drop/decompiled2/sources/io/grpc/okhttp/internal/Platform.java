...
public class Platform {
    ...
    private static Platform findPlatform() throws NoSuchMethodException {
        ...
        if (androidSecurityProvider != null) {
            ...
            if (androidSecurityProvider.getName().equals("GmsCore_OpenSSL") || androidSecurityProvider.getName().equals("Conscrypt") || androidSecurityProvider.getName().equals("Ssl_Guard") || isAtLeastAndroid5()) {
