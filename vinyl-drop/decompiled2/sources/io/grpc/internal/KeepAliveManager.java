                ...
                synchronized (KeepAliveManager.this) {
                    ...
                    if (state == state2) {
                        ...
                        if (keepAliveManager.state == State.PING_DELAYED) {
                            ...
                            keepAliveManager3.pingFuture = keepAliveManager3.scheduler.schedule(KeepAliveManager.this.sendPing, KeepAliveManager.this.keepAliveTimeInNanos - KeepAliveManager.this.stopwatch.elapsed(TimeUnit.NANOSECONDS), TimeUnit.NANOSECONDS);
