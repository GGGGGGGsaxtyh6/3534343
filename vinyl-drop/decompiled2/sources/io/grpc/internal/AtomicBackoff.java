...
public final class AtomicBackoff {
    ...
    public final class State {
        ...
        public void backoff() {
            ...
            if (AtomicBackoff.this.value.compareAndSet(this.savedValue, jMax)) {
                AtomicBackoff.log.log(Level.WARNING, "Increased {0} to {1}", new Object[]{AtomicBackoff.this.name, Long.valueOf(jMax)});
            }
        }
    }
}
